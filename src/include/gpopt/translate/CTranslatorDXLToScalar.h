...
private:
	...
	Expr *TranslateDXLScalarCaseTestToScalar(const CDXLNode *scalar_case_test_node,
											 CMappingColIdVar *colid_var);
	...
	Expr *TranslateDXLSubplanTestExprToScalar(CDXLNode *test_expr_node, SubLinkType slink,
	...
	List *TranslateDXLArrayRefIndexListToScalar(
		...
		CDXLScalarArrayRefIndexList::EIndexListBound index_list_bound, CMappingColIdVar *colid_var);
