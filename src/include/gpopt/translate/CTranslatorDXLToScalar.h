...
private:
	...
	Expr *TranslateDXLScalarCaseTestToScalar(const CDXLNode *scalar_case_test_node, CMappingColIdVar *colid_var);
	...
	// build subplan node
	SubPlan *TranslateSubplanFromChildPlan(Plan *plan_child, SubLinkType slink,
	...
	Expr *TranslateDXLScalarDMLActionToScalar(const CDXLNode *dml_action_node, CMappingColIdVar *colid_var);
	...
	Expr *TranslateRelabelTypeOrFuncExprFromDXL(const CDXLScalarCast *scalar_cast, Expr *pexprChild);
...
public:
	...
	Expr *TranslateDXLScalarIdentToScalar(const CDXLNode *scalar_id_node, CMappingColIdVar *colid_var);
