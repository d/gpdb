...
public:
	...
	void LoadIndexColumns(ULONG query_level, ULONG RTE_index, const IMDIndex *index,
	...
	void LoadCTEColumns(ULONG query_level, ULONG RTE_index, const ULongPtrArray *pdrgpulCTE,
						List *target_list);
