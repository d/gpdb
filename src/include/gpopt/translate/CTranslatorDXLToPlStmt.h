...
class CTranslatorDXLToPlStmt
{
	...
	typedef Plan *(CTranslatorDXLToPlStmt::*PfPplan)(const CDXLNode *dxlnode, CDXLTranslateContext *output_context,
...
private:
	...
	Plan *TranslateDXLIndexScan(
		const CDXLNode *index_scan_dxlnode, CDXLPhysicalIndexScan *dxl_physical_idx_scan_op,
	...
	RangeTblEntry *TranslateDXLTblDescrToRangeTblEntry(const CDXLTableDescr *table_descr, Index index,
													   CDXLTranslateContextBaseTable *base_table_context);
	...
	void TranslateSortCols(const CDXLNode *sort_col_list_dxl, const CDXLTranslateContext *child_context,
	...
	void AddJunkTargetEntryForColId(List **target_list, CDXLTranslateContext *dxl_translate_ctxt, ULONG colid,
									const char *resname);
	...
	List *TranslateNestLoopParamList(CDXLColRefArray *pdrgdxlcrOuterRefs, CDXLTranslateContext *dxltrctxLeft,
