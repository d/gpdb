...
typedef CHashMap<ULONG, BOOL, gpos::HashValue<ULONG>, gpos::Equals<ULONG>, CleanupDelete<ULONG>,
				 CleanupDelete<BOOL> >
	UlongBoolHashMap;

typedef CHashMapIter<INT, ULONG, gpos::HashValue<INT>, gpos::Equals<INT>, CleanupDelete<INT>,
					 CleanupDelete<ULONG> >
	IntUlongHashmapIter;
...
private:
	...
	CDXLNode *CreateDXLSetOpFromColumns(EdxlSetOpType setop_type, List *output_target_list,
	...
	CDXLNode *TranslateWindowToDXL(CDXLNode *child_dxlnode, List *target_list, List *window_clause,
								   List *sort_clause,
								   IntToUlongMap *sort_col_attno_to_colid_mapping,
								   IntToUlongMap *output_attno_to_colid_mapping);

	// translate window spec
	CDXLWindowSpecArray *TranslateWindowSpecToDXL(List *window_clause,
												  IntToUlongMap *sort_col_attno_to_colid_mapping,
	...
	CDXLNode *TranslateGroupingSets(FromExpr *from_expr, List *target_list, List *group_clause,
	...
	CDXLNode *CreateDXLUnionAllForGroupingSets(
		...
		CBitSetArray *pdrgpbsGroupingSets, IntToUlongMap *phmiulSortGrpColsColId,
		IntToUlongMap *output_attno_to_colid_mapping,
		UlongToUlongMap *
	...
	CDXLNode *CreateDXLProjectNullsForGroupingSets(
		...
		IntToUlongMap *sort_grouping_col_mapping, IntToUlongMap *output_attno_to_colid_mapping,
	...
	CDXLNode *CreateDXLProjectGroupingFuncs(List *target_list, CDXLNode *child_dxlnode,
											CBitSet *bitset,
											IntToUlongMap *output_attno_to_colid_mapping,
	...
	void AddSortingGroupingColumn(TargetEntry *target_entry, IntToUlongMap *phmiulSortGrpColsColId,
								  ULONG colid) const;
	...
	void StoreAttnoColIdMapping(IntToUlongMap *attno_to_colid_mapping, INT attno,
								ULONG colid) const;
	...
	void ConstructCTEAnchors(CDXLNodeArray *dxlnodes, CDXLNode **dxl_cte_anchor_top,
	...
	IntToUlongMap *RemapColIds(CMemoryPool *mp, IntToUlongMap *attno_to_colid_mapping,
...
public:
	...
	// factory function
	static CTranslatorQueryToDXL *QueryToDXLInstance(CMemoryPool *mp, CMDAccessor *md_accessor,
													 Query *query);
};
}  // namespace gpdxl
