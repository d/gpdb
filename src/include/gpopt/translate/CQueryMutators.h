...
public:
	...
	// normalize query
	static Query *NormalizeQuery(CMemoryPool *mp, CMDAccessor *md_accessor, const Query *query,
								 ULONG query_level);
	...
	static Query *NormalizeWindowProjList(CMemoryPool *mp, CMDAccessor *md_accessor,
	...
	static Query *NormalizeGroupByProjList(CMemoryPool *mp, CMDAccessor *md_accessor,
										   const Query *query);
	...
	static TargetEntry *GetTargetEntryForAggExpr(CMemoryPool *mp, CMDAccessor *md_accessor,
