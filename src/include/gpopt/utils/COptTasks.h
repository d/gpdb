...
private:
	...
	static PlannedStmt *ConvertToPlanStmtFromDXL(CMemoryPool *mp, CMDAccessor *md_accessor,
	...
	static void PrintMissingStatsWarning(CMemoryPool *mp, CMDAccessor *md_accessor,
										 IMdIdArray *col_stats, MdidHashSet *phsmdidRel);
