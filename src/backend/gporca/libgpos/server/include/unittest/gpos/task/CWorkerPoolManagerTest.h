...
public:
	...
	static void Unittest_TestTaskPerformance(ULONG culWrkrCnt, ULONG culIterCnt,
											 void *funcSingle(void *), void *funcRepeated(void *));

	static void Unittest_TestSingleTaskPerformance(CMemoryPool *mp, ULONG culWrkrCnt,
												   ULONG culIterCnt, void *funcRepeated(void *));

	static void Unittest_TestMultiTaskPerformance(CMemoryPool *mp, ULONG culWrkrCnt,
												  ULONG culIterCnt, void *funcSingle(void *));
