...
CExceptionTest::EresUnittest()
{
	CUnittest rgut[] = {GPOS_UNITTEST_FUNC(CExceptionTest::EresUnittest_BasicThrow),
...
#ifdef GPOS_DEBUG
						GPOS_UNITTEST_FUNC_THROW(CExceptionTest::EresUnittest_BasicRethrow, CException::ExmaSystem,
												 CException::ExmiOOM),
