...
CSyncHashtableTest::EresUnittest_Basics()
{
	...
	sht.Init(mp, GPOS_SHT_SMALL_BUCKETS, GPOS_OFFSET(SElem, m_link), GPOS_OFFSET(SElem, m_ulKey),
...
CSyncHashtableTest::EresUnittest_Accessor()
{
	...
	rgsht[0].Init(mp, GPOS_SHT_SMALL_BUCKETS, GPOS_OFFSET(SElem, m_link),
				  GPOS_OFFSET(SElem, m_ulKey), &(SElem::m_ulInvalid), SElem::HashValue,
				  SElem::FEqualKeys);
...
CSyncHashtableTest::EresUnittest_ComplexEquality()
{
	...
	sht.Init(mp, GPOS_SHT_SMALL_BUCKETS, GPOS_OFFSET(SElem, m_link), 0 /*cKeyOffset*/,
			 &(SElem::m_elemInvalid), SElem::HashValue, SElem::Equals);
