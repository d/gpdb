...
CHashMapIterTest::EresUnittest_Basic()
{
	...
	typedef CHashMap<ULONG, ULONG, HashPtr<ULONG>, gpos::Equals<ULONG>, CleanupNULL<ULONG>,
					 CleanupNULL<ULONG> >
		Map;

	typedef CHashMapIter<ULONG, ULONG, HashPtr<ULONG>, gpos::Equals<ULONG>, CleanupNULL<ULONG>,
						 CleanupNULL<ULONG> >
		MapIter;
