...
CHashMapTest::EresUnittest_Basic()
{
	...
	typedef CHashMap<ULONG_PTR, CHAR, HashPtr<ULONG_PTR>, gpos::Equals<ULONG_PTR>, CleanupNULL<ULONG_PTR>,
					 CleanupNULL<CHAR> >
		UlongPtrToCharMap;
	...
	typedef CHashMap<ULONG, ULONG, HashValue<ULONG>, gpos::Equals<ULONG>, CleanupDelete<ULONG>, CleanupDelete<ULONG> >
		UlongToUlongMap;
...
CHashMapTest::EresUnittest_Ownership()
{
	...
	typedef CHashMap<ULONG_PTR, CHAR, HashPtr<ULONG_PTR>, gpos::Equals<ULONG_PTR>, CleanupDelete<ULONG_PTR>,
