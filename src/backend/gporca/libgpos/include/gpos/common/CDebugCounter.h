...
class CDebugCounter
{
	...
	typedef CHashMap<SDebugCounterKey, SDebugCounterValue, SDebugCounterKey::HashValue,
					 SDebugCounterKey::Equals, CleanupRelease<SDebugCounterKey>,
					 CleanupRelease<SDebugCounterValue> >
		CounterKeyToValueMap;

	// ...and an iterator type for the hash table type above
	typedef CHashMapIter<SDebugCounterKey, SDebugCounterValue, SDebugCounterKey::HashValue,
						 SDebugCounterKey::Equals, CleanupRelease<SDebugCounterKey>,
						 CleanupRelease<SDebugCounterValue> >
...
private:
	...
	BOOL FindByName(const char *counter_name, SDebugCounterKey **key, SDebugCounterValue **val,
