...
public:
	...
	// ctor
	CSyncHashtable<T, K>()
		: m_buckets(NULL), m_nbuckets(0), m_size(0), m_key_offset(gpos::ulong_max), m_invalid_key(NULL)
	{
	}
	...
	void
	Init(CMemoryPool *mp, ULONG size, ULONG link_offset, ULONG key_offset, const K *invalid_key,
