...
CMessage::GetMessage(ULONG index)
{
	...
	static CMessage msg[CException::ExmiSentinel] = {
		...
		CMessage(CException(CException::ExmaSystem, CException::ExmiIllegalByteSequence), CException::ExsevError,
				 GPOS_WSZ_WSZLEN("Invalid multibyte character for locale encountered in metadata name"), 0,
