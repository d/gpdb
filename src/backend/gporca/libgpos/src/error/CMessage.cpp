...
//
//---------------------------------------------------------------------------
CMessage::CMessage(CException exc, ULONG severity, const WCHAR *wszFmt, ULONG ulLenFmt,
...
CMessage::GetMessage(ULONG index)
{
	...
	static CMessage msg[CException::ExmiSentinel] = {
		...
		CMessage(
			CException(CException::ExmaSystem, CException::ExmiIOError), CException::ExsevError,
		...
		CMessage(CException(CException::ExmaSystem, CException::ExmiDummyWarning),
				 CException::ExsevWarning, GPOS_WSZ_WSZLEN("This is a dummy warning"),
				 1,	 // # params
