...
// ctor
CMDArrayCoerceCastGPDB::CMDArrayCoerceCastGPDB(CMemoryPool *mp, IMDId *mdid, CMDName *mdname,
											   ...
											   INT location)
	: CMDCastGPDB(mp, mdid, mdname, mdid_src, mdid_dest, is_binary_coercible, mdid_cast_func,
				  path_type),
