...
//
//---------------------------------------------------------------------------
CDXLColStats::CDXLColStats(CMemoryPool *mp, CMDIdColStats *mdid_col_stats, CMDName *mdname,
						   CDouble width, CDouble null_freq, CDouble distinct_remaining,
...
CDXLColStats::CreateDXLDummyColStats(CMemoryPool *mp, IMDId *mdid, CMDName *mdname, CDouble width)
{
	...
	dxl_col_stats =
		GPOS_NEW(mp) CDXLColStats(mp, mdid_col_stats, mdname, width, CHistogram::DefaultNullFreq,
