...
//---------------------------------------------------------------------------
IDatumInt8 *
CMDTypeInt8GPDB::CreateInt8Datum(CMemoryPool *mp, LINT value, BOOL is_null) const
{
...
//---------------------------------------------------------------------------
IDatum *
CMDTypeInt8GPDB::GetDatumForDXLDatum(CMemoryPool *mp, const CDXLDatum *dxl_datum) const
{
