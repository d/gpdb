...
//
//---------------------------------------------------------------------------
CMDPartConstraintGPDB::CMDPartConstraintGPDB(CMemoryPool *mp, ULongPtrArray *level_with_default_part_array,
...
//---------------------------------------------------------------------------
CExpression *
CMDPartConstraintGPDB::GetPartConstraintExpr(CMemoryPool *mp, CMDAccessor *md_accessor,
