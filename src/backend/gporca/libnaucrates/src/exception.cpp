...
gpdxl::EresExceptionInit(CMemoryPool *mp)
{
	...
	CMessage rgmsg[ExmiDXLSentinel] = {
		...
		CMessage(CException(gpdxl::ExmaDXL, gpdxl::ExmiDXLUnrecognizedOperator),
				 CException::ExsevError, GPOS_WSZ_WSZLEN("DXL: Unrecognized operator: %ls"),
				 1,	 // elemname
		...
		CMessage(CException(gpdxl::ExmaDXL, gpdxl::ExmiDXLUnrecognizedCompOperator),
				 CException::ExsevError, GPOS_WSZ_WSZLEN("Unrecognized comparison operator"),
				 1,	 // comp op
		...
		CMessage(CException(gpdxl::ExmaDXL, gpdxl::ExmiDXLIncorrectNumberOfChildren),
				 CException::ExsevError, GPOS_WSZ_WSZLEN("Incorrect Number of children"),
				 0,	 //
		...
		CMessage(CException(gpdxl::ExmaDXL, gpdxl::ExmiQuery2DXLUnsupportedFeature),
				 CException::ExsevNotice, GPOS_WSZ_WSZLEN("Feature not supported: %ls"),
				 1,	 //
		...
		CMessage(
			CException(gpdxl::ExmaDXL, gpdxl::ExmiQuery2DXLError), CException::ExsevError,
			GPOS_WSZ_WSZLEN(
		...
		CMessage(CException(gpdxl::ExmaDXL, gpdxl::ExmiExpr2DXLUnsupportedFeature),
				 CException::ExsevError, GPOS_WSZ_WSZLEN("Feature not supported: %ls"),
				 1,	 // feature name
				 GPOS_WSZ_WSZLEN("Feature not supported: %ls")),
		...
		CMessage(CException(gpdxl::ExmaDXL, gpdxl::ExmiOptimizerError), CException::ExsevError,
				 GPOS_WSZ_WSZLEN("%s"),
				 1,	 // attno
				 GPOS_WSZ_WSZLEN(
