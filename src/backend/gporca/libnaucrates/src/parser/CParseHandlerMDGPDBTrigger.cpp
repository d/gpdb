...
//
//---------------------------------------------------------------------------
CParseHandlerMDGPDBTrigger::CParseHandlerMDGPDBTrigger(CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr,
										 ...
										 const Attributes &attrs)
{
	...
	gpmd_trigger_properties[GPMD_TRIGGER_ROW_BIT] = CDXLOperatorFactory::ExtractConvertAttrValueToBool(
		m_parse_handler_mgr->GetDXLMemoryManager(), attrs, EdxltokenGPDBTriggerRow, EdxltokenGPDBTrigger);
	gpmd_trigger_properties[GPMD_TRIGGER_BEFORE_BIT] = CDXLOperatorFactory::ExtractConvertAttrValueToBool(
		m_parse_handler_mgr->GetDXLMemoryManager(), attrs, EdxltokenGPDBTriggerBefore, EdxltokenGPDBTrigger);
	gpmd_trigger_properties[GPMD_TRIGGER_INSERT_BIT] = CDXLOperatorFactory::ExtractConvertAttrValueToBool(
		m_parse_handler_mgr->GetDXLMemoryManager(), attrs, EdxltokenGPDBTriggerInsert, EdxltokenGPDBTrigger);
	gpmd_trigger_properties[GPMD_TRIGGER_DELETE_BIT] = CDXLOperatorFactory::ExtractConvertAttrValueToBool(
		m_parse_handler_mgr->GetDXLMemoryManager(), attrs, EdxltokenGPDBTriggerDelete, EdxltokenGPDBTrigger);
	gpmd_trigger_properties[GPMD_TRIGGER_UPDATE_BIT] = CDXLOperatorFactory::ExtractConvertAttrValueToBool(
		m_parse_handler_mgr->GetDXLMemoryManager(), attrs, EdxltokenGPDBTriggerUpdate, EdxltokenGPDBTrigger);
	...
	m_is_enabled = CDXLOperatorFactory::ExtractConvertAttrValueToBool(
		m_parse_handler_mgr->GetDXLMemoryManager(), attrs, EdxltokenGPDBTriggerEnabled, EdxltokenGPDBTrigger);
}
...
)
{
	...
	m_imd_obj = GPOS_NEW(m_mp) CMDTriggerGPDB(m_mp, m_mdid, m_mdname, m_rel_mdid, m_func_mdid, m_type, m_is_enabled);
