...
//---------------------------------------------------------------------------
void
CParseHandlerBase::startElement(const XMLCh *const element_uri, const XMLCh *const element_local_name,
...
//---------------------------------------------------------------------------
void
CParseHandlerBase::endElement(const XMLCh *const element_uri, const XMLCh *const element_local_name,
