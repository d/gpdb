...
//
//---------------------------------------------------------------------------
CParseHandlerWindowFrame::CParseHandlerWindowFrame(CMemoryPool *mp,
									   ...
									   const Attributes &attrs)
{
		...
		XMLString::compareString(CDXLTokens::XmlstrToken(EdxltokenWindowFrame), element_local_name))
	{
		...
		CParseHandlerBase *trailing_val_parse_handler_base = CParseHandlerFactory::GetParseHandler(
			m_mp, CDXLTokens::XmlstrToken(EdxltokenScalarWindowFrameTrailingEdge),
		...
		CParseHandlerBase *leading_val_parse_handler_base = CParseHandlerFactory::GetParseHandler(
			m_mp, CDXLTokens::XmlstrToken(EdxltokenScalarWindowFrameLeadingEdge),
			m_parse_handler_mgr, this);
...
)
{
	...
	m_window_frame =
		GPOS_NEW(m_mp) CDXLWindowFrame(m_mp, m_dxl_win_frame_spec, m_dxl_frame_exclusion_strategy,
