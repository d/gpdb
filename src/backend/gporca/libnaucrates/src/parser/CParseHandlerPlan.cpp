...
//---------------------------------------------------------------------------
void
CParseHandlerPlan::StartElement(const XMLCh *const element_uri, const XMLCh *const element_local_name,
								const XMLCh *const element_qname, const Attributes &attrs)
{
	...
	m_plan_id = CDXLOperatorFactory::ConvertAttrValueToUllong(m_parse_handler_mgr->GetDXLMemoryManager(),
															  xml_str_plan_id, EdxltokenPlanId, EdxltokenPlan);
