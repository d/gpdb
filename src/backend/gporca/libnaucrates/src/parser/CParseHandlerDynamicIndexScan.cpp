											...
											const Attributes &attrs)
{
	...
	m_part_index_id = CDXLOperatorFactory::ExtractConvertAttrValueToUlong(
		m_parse_handler_mgr->GetDXLMemoryManager(), attrs, EdxltokenPartIndexId, EdxltokenPhysicalDynamicIndexScan);
	m_part_index_id_printable = CDXLOperatorFactory::ExtractConvertAttrValueToUlong(
		...
		EdxltokenPhysicalDynamicIndexScan, true /*is_optional*/, m_part_index_id);
}
