...
//
//---------------------------------------------------------------------------
CParseHandlerMDRequest::CParseHandlerMDRequest(CMemoryPool *mp,
									 ...
									 const Attributes &attrs)
{
	...
	CSystemId sysid = CDXLOperatorFactory::Sysid(m_parse_handler_mgr->GetDXLMemoryManager(), attrs,
												 EdxltokenSysid, EdxltokenMDTypeRequest);
									  ...
									  element_local_name))
	{
		...
		IMDType::ETypeInfo type_info =
			(IMDType::ETypeInfo) CDXLOperatorFactory::ExtractConvertAttrValueToUlong(
				m_parse_handler_mgr->GetDXLMemoryManager(), attrs, EdxltokenTypeInfo,
