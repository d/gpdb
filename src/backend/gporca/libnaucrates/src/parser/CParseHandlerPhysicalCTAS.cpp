										...
										const Attributes &attrs)
{
	...
	m_has_oids = CDXLOperatorFactory::ExtractConvertAttrValueToBool(m_parse_handler_mgr->GetDXLMemoryManager(), attrs,
																	EdxltokenRelHasOids, EdxltokenPhysicalCTAS);
...
)
{
	...
	m_dxl_node = GPOS_NEW(m_mp) CDXLNode(
		m_mp, GPOS_NEW(m_mp) CDXLPhysicalCTAS(m_mp, m_mdname_schema, m_mdname, dxl_col_descr_array, ctas_options,
											  m_rel_distr_policy, m_distr_column_pos_array, m_is_temp_table, m_has_oids,
