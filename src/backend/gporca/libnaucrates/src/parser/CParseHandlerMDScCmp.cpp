								   ...
								   const Attributes &attrs)
{
	...
	IMDId *mdid_left = CDXLOperatorFactory::ExtractConvertAttrValueToMdId(
		m_parse_handler_mgr->GetDXLMemoryManager(), attrs, EdxltokenGPDBScalarOpLeftTypeId,
		EdxltokenGPDBMDScCmp);

	IMDId *mdid_right = CDXLOperatorFactory::ExtractConvertAttrValueToMdId(
		m_parse_handler_mgr->GetDXLMemoryManager(), attrs, EdxltokenGPDBScalarOpRightTypeId,
		EdxltokenGPDBMDScCmp);
