											  ...
											  const Attributes &attrs)
{
									  ...
									  element_local_name))
	{
		m_dispatch_is_raw = CDXLOperatorFactory::ExtractConvertAttrValueToBool(
			m_parse_handler_mgr->GetDXLMemoryManager(), attrs, EdxltokenDirectDispatchIsRaw,
...
)
{
									  ...
									  element_local_name))
	{
		m_direct_dispatch_info =
			GPOS_NEW(m_mp) CDXLDirectDispatchInfo(m_datum_array_combination, m_dispatch_is_raw);
