...
CParseHandlerSearchStage::CParseHandlerSearchStage(CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr,
	...
	: CParseHandlerBase(mp, parse_handler_mgr, parse_handler_root), m_xforms(NULL), m_cost_threshold(GPOPT_INVALID_COST)
{
}
...
//---------------------------------------------------------------------------
void
CParseHandlerSearchStage::StartElement(const XMLCh *const element_uri, const XMLCh *const element_local_name,
