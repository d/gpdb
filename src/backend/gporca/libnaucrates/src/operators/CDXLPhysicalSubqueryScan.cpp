...
//
//---------------------------------------------------------------------------
CDXLPhysicalSubqueryScan::CDXLPhysicalSubqueryScan(CMemoryPool *mp, CMDName *mdname)
...
//---------------------------------------------------------------------------
void
CDXLPhysicalSubqueryScan::SerializeToDXL(CXMLSerializer *xml_serializer, const CDXLNode *dxlnode) const
{
