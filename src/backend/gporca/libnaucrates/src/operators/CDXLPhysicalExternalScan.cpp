...
//
//---------------------------------------------------------------------------
CDXLPhysicalExternalScan::CDXLPhysicalExternalScan(CMemoryPool *mp) : CDXLPhysicalTableScan(mp)
{
}
...
//
//---------------------------------------------------------------------------
CDXLPhysicalExternalScan::CDXLPhysicalExternalScan(CMemoryPool *mp, CDXLTableDescr *table_descr)
