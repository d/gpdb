...
//
//---------------------------------------------------------------------------
CDXLNode::CDXLNode(CMemoryPool *mp) : m_mp(mp), m_dxl_op(NULL), m_dxl_properties(NULL), m_direct_dispatch_info(NULL)
{
...
CDXLNode::CDXLNode(CMemoryPool *mp, CDXLOperator *dxl_op, CDXLNode *child_dxlnode)
	: m_mp(mp), m_dxl_op(dxl_op), m_dxl_properties(NULL), m_dxl_array(NULL), m_direct_dispatch_info(NULL)
{
	GPOS_ASSERT(NULL != dxl_op);
...
//
//---------------------------------------------------------------------------
CDXLNode::CDXLNode(CMemoryPool *mp, CDXLOperator *dxl_op, CDXLNodeArray *dxl_array)
	: m_mp(mp), m_dxl_op(dxl_op), m_dxl_properties(NULL), m_dxl_array(dxl_array), m_direct_dispatch_info(NULL)
{
	GPOS_ASSERT(NULL != dxl_op);
