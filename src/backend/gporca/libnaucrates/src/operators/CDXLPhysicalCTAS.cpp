...
CDXLPhysicalCTAS::CDXLPhysicalCTAS(
	...
	gpos::owner<CDXLCtasStorageOptions *> dxl_ctas_opt,
	...
	: CDXLPhysical(mp),
	  ...
	  m_dxl_ctas_storage_option(std::move(dxl_ctas_opt)),
...
//---------------------------------------------------------------------------
void
CDXLPhysicalCTAS::AssertValid(gpos::pointer<const CDXLNode *> dxlnode,
