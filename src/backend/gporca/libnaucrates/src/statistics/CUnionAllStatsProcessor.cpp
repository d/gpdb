...
CStatistics *
CUnionAllStatsProcessor::CreateStatsForUnionAll(CMemoryPool *mp,
												...
												ULongPtrArray *second_child_colids)
{
	...
	CStatistics *unionall_stats =
		GPOS_NEW(mp) CStatistics(mp, histograms_new, column_to_width_map, unionall_rows,
