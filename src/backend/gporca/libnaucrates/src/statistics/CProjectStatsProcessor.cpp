...
CStatistics *
CProjectStatsProcessor::CalcProjStats(CMemoryPool *mp, const CStatistics *input_stats,
									  ULongPtrArray *projection_colids, UlongToIDatumMap *datum_map)
{
	...
	CStatistics *projection_stats =
		GPOS_NEW(mp) CStatistics(mp, histograms_new, colid_width_mapping, input_rows,
