...
CStatistics *
CProjectStatsProcessor::CalcProjStats(CMemoryPool *mp, const CStatistics *input_stats, ULongPtrArray *projection_colids,
									  UlongToIDatumMap *datum_map)
{
	...
	for (ULONG ul = 0; ul < length; ul++)
	{
		...
		if (NULL == histogram)
		{
			...
			{
				proj_col_histogram =
					GPOS_NEW(mp) CHistogram(mp, proj_col_bucket, is_well_defined, null_freq,
