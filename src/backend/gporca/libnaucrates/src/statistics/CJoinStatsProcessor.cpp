...
void
CJoinStatsProcessor::JoinHistograms(CMemoryPool *mp, const CHistogram *histogram1, const CHistogram *histogram2,
									...
									BOOL DoIgnoreLASJHistComputation)
{
	...
	{
		CLeftAntiSemiJoinStatsProcessor::JoinHistogramsLASJ(histogram1, histogram2, join_pred_stats, num_rows1,
															num_rows2, result_hist1, result_hist2, scale_factor,
															is_input_empty, join_type, DoIgnoreLASJHistComputation);
...
IStatistics *
CJoinStatsProcessor::CalcAllJoinStats(CMemoryPool *mp, IStatisticsArray *statistics_array, CExpression *expr,
									  COperator *pop)
{
...
CDouble
CJoinStatsProcessor::CalcJoinCardinality(CMemoryPool *mp, CStatisticsConfig *stats_config, CDouble left_num_rows,
...
BOOL
CJoinStatsProcessor::JoinStatsAreEmpty(BOOL outer_is_empty, BOOL output_is_empty, const CHistogram *outer_histogram,
...
IStatistics *
CJoinStatsProcessor::DeriveJoinStats(CMemoryPool *mp, CExpressionHandle &exprhdl, IStatisticsArray *stats_ctxt)
{
