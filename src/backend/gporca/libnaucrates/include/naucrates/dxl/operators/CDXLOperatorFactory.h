...
private:
	...
	static LINT Value(CDXLMemoryManager *dxl_memory_manager, const Attributes &attrs,
					  Edxltoken target_elem, BYTE *data);

	// parses a byte array representation of the datum
	static BYTE *GetByteArray(CDXLMemoryManager *dxl_memory_manager, const Attributes &attrs,
...
public:
	...
	static CDXLDatum *GetDatumOid(CDXLMemoryManager *dxl_memory_manager, const Attributes &attrs,
								  Edxltoken target_elem, IMDId *mdid, BOOL is_const_null);

	static CDXLDatum *GetDatumInt2(CDXLMemoryManager *dxl_memory_manager, const Attributes &attrs,
								   Edxltoken target_elem, IMDId *mdid, BOOL is_const_null);

	static CDXLDatum *GetDatumInt4(CDXLMemoryManager *dxl_memory_manager, const Attributes &attrs,
								   Edxltoken target_elem, IMDId *mdid, BOOL is_const_null);

	static CDXLDatum *GetDatumInt8(CDXLMemoryManager *dxl_memory_manager, const Attributes &attrs,
								   Edxltoken target_elem, IMDId *mdid, BOOL is_const_null);

	static CDXLDatum *GetDatumBool(CDXLMemoryManager *dxl_memory_manager, const Attributes &attrs,
								   Edxltoken target_elem, IMDId *mdid, BOOL is_const_null);
	...
	static CDXLColRef *MakeDXLColRef(CDXLMemoryManager *dxl_memory_manager, const Attributes &,
									 Edxltoken);
	...
	static const XMLCh *ExtractAttrValue(const Attributes &, Edxltoken target_attr,
										 Edxltoken target_elem, BOOL is_optional = false);

	// extracts the boolean value for the given attribute
	// will raise an exception if value cannot be converted to a boolean
	static BOOL ConvertAttrValueToBool(CDXLMemoryManager *dxl_memory_manager, const XMLCh *xml_val,
									   Edxltoken target_attr, Edxltoken target_elem);

	// converts the XMLCh into LINT
	static LINT ConvertAttrValueToLint(CDXLMemoryManager *dxl_memory_manager, const XMLCh *xml_val,
									   Edxltoken target_attr, Edxltoken target_elem);
	...
	static LINT ExtractConvertAttrValueToLint(CDXLMemoryManager *dxl_memory_manager,
											  const Attributes &attr, Edxltoken target_attr,
											  Edxltoken target_elem, BOOL is_optional = false,
	...
	static INT ConvertAttrValueToInt(CDXLMemoryManager *dxl_memory_manager, const XMLCh *xml_val,
									 Edxltoken target_attr, Edxltoken target_elem);
	...
	static CHAR ConvertAttrValueToChar(CDXLMemoryManager *dxl_memory_manager, const XMLCh *xml_val,
									   Edxltoken target_attr, Edxltoken target_elem);

	// converts the XMLCh into oid. Will raise an exception if the
	// argument cannot be converted to OID
	static OID ConvertAttrValueToOid(CDXLMemoryManager *dxl_memory_manager, const XMLCh *xml_val,
									 Edxltoken target_attr, Edxltoken target_elem);
	...
	// parse a string value from the value for a given attribute
	static CHAR *ConvertAttrValueToSz(CDXLMemoryManager *dxl_memory_manager, const XMLCh *xml_val,
									  Edxltoken target_attr, Edxltoken target_elem);
	...
	static IMDId *MakeMdIdFromStr(CDXLMemoryManager *dxl_memory_manager, const XMLCh *mdid_xml,
								  Edxltoken target_attr, Edxltoken target_elem);
	...
	static CDXLDatum *GetDatumVal(CDXLMemoryManager *dxl_memory_manager, const Attributes &attrs,
								  Edxltoken target_elem);
	...
	static CDynamicPtrArray<T, CleanupFn> *ExtractIntsToArray(CDXLMemoryManager *dxl_memory_manager,
															  const XMLCh *xmlszUl,
															  Edxltoken target_attr,
															  Edxltoken target_elem);

	static ULongPtrArray *
	ExtractIntsToUlongArray(CDXLMemoryManager *dxl_memory_manager, const XMLCh *xmlszUl,
							Edxltoken target_attr, Edxltoken target_elem)
	{
	...
	static IntPtrArray *
	ExtractIntsToIntArray(CDXLMemoryManager *dxl_memory_manager, const XMLCh *xmlszUl,
						  Edxltoken target_attr, Edxltoken target_elem)
	{
	...
	// will raise an exception if list is not well-formed
	static CharPtrArray *ExtractConvertPartitionTypeToArray(CDXLMemoryManager *dxl_memory_manager,
															const XMLCh *xml_val,
															Edxltoken target_attr,
															Edxltoken target_elem);
	...
	// will raise an exception if list is not well-formed
	static ULongPtr2dArray *ExtractConvertUlongTo2DArray(CDXLMemoryManager *dxl_memory_manager,
														 const XMLCh *xml_val,
														 Edxltoken target_attr,
														 Edxltoken target_elem);
	...
	static void SetSegmentInfo(CDXLMemoryManager *mp, CDXLPhysicalMotion *motion,
							   const Attributes &attrs, Edxltoken target_elem);
	...
	// parse system id
	static CSystemId Sysid(CDXLMemoryManager *dxl_memory_manager, const Attributes &attrs,
						   Edxltoken target_attr, Edxltoken target_elem);
