...
public:
	...
	// ctor
	CMDCastGPDB(CMemoryPool *mp, gpos::Ref<IMDId> mdid, CMDName *mdname,
				gpos::Ref<IMDId> mdid_src, gpos::Ref<IMDId> mdid_dest,
				BOOL is_binary_coercible, gpos::Ref<IMDId> mdid_cast_func,
