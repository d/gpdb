...
public:
	// ctor
	CMDTypeGenericGPDB(CMemoryPool *mp, IMDId *mdid, CMDName *mdname, BOOL is_redistributable,
					   BOOL is_fixed_length, ULONG length, BOOL is_passed_by_value,
					   IMDId *mdid_distr_opfamily, IMDId *mdid_legacy_distr_opfamily,
					   IMDId *mdid_op_eq, IMDId *mdid_op_neq, IMDId *mdid_op_lt, IMDId *mdid_op_leq,
					   IMDId *mdid_op_gt, IMDId *mdid_op_geq, IMDId *mdid_op_cmp, IMDId *pmdidMin,
	...
	virtual IDatum *GetDatumForDXLDatum(CMemoryPool *mp, const CDXLDatum *dxl_datum) const;
	...
	virtual CDXLScalarConstValue *GetDXLOpScConst(CMemoryPool *mp, IDatum *datum) const;
	...
	// create a dxl datum
	static CDXLDatum *CreateDXLDatumVal(CMemoryPool *mp, IMDId *mdid, const IMDType *md_type,
										INT type_modifier, BOOL is_null, BYTE *byte_array,
										ULONG length, LINT lint_Value, CDouble double_Value);

	// create a dxl datum of types having double mapping
	static CDXLDatum *CreateDXLDatumStatsDoubleMappable(CMemoryPool *mp, IMDId *mdid,
	...
	static CDXLDatum *CreateDXLDatumStatsIntMappable(CMemoryPool *mp, IMDId *mdid,
													 INT type_modifier, BOOL is_null,
													 BYTE *byte_array, ULONG length,
													 LINT lint_Value, CDouble double_Value);
