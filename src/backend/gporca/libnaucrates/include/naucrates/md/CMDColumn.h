...
public:
	// ctor
	CMDColumn(CMDName *mdname, INT attrnum, IMDId *mdid_type, INT type_modifier, BOOL is_nullable,
			  BOOL is_dropped, gpdxl::CDXLNode *dxl_dafault_value, ULONG length = gpos::ulong_max);
