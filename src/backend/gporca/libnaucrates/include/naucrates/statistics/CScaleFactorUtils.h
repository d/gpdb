...
public:
	...
	typedef CHashMap<IMdIdArray, CDoubleArray, SJoinCondition::HashValue, SJoinCondition::Equals,
	...
	static CDouble CalcCumulativeScaleFactorSqrtAlg(
		OIDPairToScaleFactorArrayMap *scale_factor_hashmap, CDoubleArray *complex_join_preds);
	...
	static INT DoubleCmpFunc(const CDouble *double_data1, const CDouble *double_data2,
							 BOOL is_descending);
