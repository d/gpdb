...
public:
	// ctor
	CBucket(CPoint *bucket_lower_bound, CPoint *bucket_upper_bound, BOOL is_lower_closed,
	...
	void Difference(CMemoryPool *mp, CBucket *bucket_other, CBucket **result_bucket_lower,
	...
	CBucket *SplitAndMergeBuckets(CMemoryPool *mp, CBucket *bucket_other, CDouble rows,
								  CDouble rows_other, CBucket **bucket1_new, CBucket **bucket2_new,
								  CDouble *result_rows, BOOL is_union_all = true);
