...
private:
	...
	static void AddWidthInfoWithRemap(CMemoryPool *mp, UlongToDoubleMap *src_width,
...
public:
	...
	virtual CDXLStatsDerivedRelation *GetDxlStatsDrvdRelation(CMemoryPool *mp,
	...
	static BOOL IsEmptyJoin(const CStatistics *outer_stats, const CStatistics *inner_side_stats,
							BOOL IsLASJ);

	// add upper bound ndvs information for a given set of columns
	static void CreateAndInsertUpperBoundNDVs(CMemoryPool *mp, CStatistics *stats,
