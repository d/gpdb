...
private:
	...
	static CHistogram *MakeHistSimpleFilter(CMemoryPool *mp, CStatsPred *pred_stats,
	...
	static CHistogram *MakeHistPointFilter(CStatsPredPoint *pred_stats, CBitSet *filter_colids,
	...
	static CHistogram *MakeHistLikeFilter(CStatsPredLike *pred_stats, CBitSet *filter_colids,
										  CHistogram *hist_before, CDouble *last_scale_factor,
										  ULONG *target_last_colid);

	// create a new histogram for an unsupported predicate
	static CHistogram *MakeHistUnsupportedPred(CStatsPredUnsupported *pred_stats,
											   CBitSet *filter_colids, CHistogram *hist_before,
											   CDouble *last_scale_factor,
											   ULONG *target_last_colid);

	// create a new histogram after applying a pred op ANY(ARRAY[...]) filter
	static CHistogram *MakeHistArrayCmpAnyFilter(CMemoryPool *mp, CStatsPredArrayCmp *pred_stats,
												 CBitSet *filter_colids, CHistogram *hist_before,
												 CDouble *last_scale_factor,
												 ULONG *target_last_colid);
	...
	static UlongToHistogramMap *MakeHistHashMapConjOrDisjFilter(
		...
		UlongToHistogramMap *input_histograms, CDouble input_rows, CStatsPred *pred_stats,
	...
	static UlongToHistogramMap *MakeHistHashMapDisjFilter(CMemoryPool *mp,
...
public:
	// filter
	static CStatistics *MakeStatsFilter(CMemoryPool *mp, const CStatistics *input_stats,
