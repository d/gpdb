...
private:
	...
	static CStatsPred *GetStatsPredFromBoolExpr(CMemoryPool *mp, CExpression *predicate_expr,
	...
	static void AddSupportedStatsFilters(CMemoryPool *mp, CStatsPredPtrArry *pdrgpstatspred,
	...
	static CStatsPred *CreateStatsPredConj(CMemoryPool *mp, CExpression *scalar_expr,
										   CColRefSet *outer_refs);

	// create a disjunction statistics filter composed of the extracted components of the disjunction
	static CStatsPred *CreateStatsPredDisj(CMemoryPool *mp, CExpression *predicate_expr,
										   CColRefSet *outer_refs);

	// return statistics filter type for the given expression
	static CStatsPredUtils::EPredicateType GetPredTypeForExpr(CMemoryPool *mp,
	...
	static CStatsPred *GetStatsPredPoint(CMemoryPool *mp, CExpression *predicate_expr,
										 CColRefSet *outer_refs);

	// extract statistics filtering information from a LIKE comparison
	static CStatsPred *GetStatsPredLike(CMemoryPool *mp, CExpression *predicate_expr,
										CColRefSet *outer_refs);

	// extract statistics filtering information from a null test
	static CStatsPred *GetStatsPredNullTest(CMemoryPool *mp, CExpression *predicate_expr,
											CColRefSet *outer_refs);

	// create an unsupported statistics predicate
	static CStatsPred *CreateStatsPredUnsupported(CMemoryPool *mp, CExpression *predicate_expr,
												  CColRefSet *outer_refs);
...
public:
	...
	static CStatsPred *ExtractPredStats(CMemoryPool *mp, CExpression *scalar_expr,
										CColRefSet *outer_refs);
	...
	static CStatsPredJoinArray *ExtractJoinStatsFromExprHandle(CMemoryPool *mp,
	...
	static CStatsPredJoinArray *ExtractJoinStatsFromExpr(
		CMemoryPool *mp, CExpressionHandle &expr_handle, CExpression *scalar_expression,
		CColRefSetArray *output_col_refset, CColRefSet *outer_refs, BOOL is_semi_or_anti_join);
