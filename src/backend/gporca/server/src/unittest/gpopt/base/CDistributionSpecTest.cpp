...
CDistributionSpecTest::EresUnittest_NegativeAny()
{
	...
	pdsany->AppendEnforcers(NULL /*mp*/, *pexprhdl, NULL /*prpp*/, NULL /*pdrgpexpr*/,
							NULL /*pexpr*/);
	pdsany->Release();
...
CDistributionSpecTest::EresUnittest_NegativeUniversal()
{
	...
	pdsuniversal->AppendEnforcers(NULL /*mp*/, *pexprhdl, NULL /*prpp*/, NULL /*pdrgpexpr*/,
								  NULL /*pexpr*/);
	pdsuniversal->Release();
	GPOS_DELETE(pexprhdl);
...
CDistributionSpecTest::EresUnittest_NegativeRandom()
{
	...
	pdsrandom->AppendEnforcers(NULL /*mp*/, *pexprhdl, NULL /*prpp*/, NULL /*pdrgpexpr*/,
							   NULL /*pexpr*/);
	pdsrandom->Release();
	GPOS_DELETE(pexprhdl);
