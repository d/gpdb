...
CEnumeratorTest::FHasNoMotions(CExpression *pexpr)
{
	COperator::EOperatorId rgeopid[] = {
		COperator::EopPhysicalMotionGather, COperator::EopPhysicalMotionHashDistribute,
...
CEnumeratorTest::EresUnittest_Sampling()
{
	...
	GPOS_TRY
	{
		eres = CTestUtils::EresSamplePlans(rgszSamplePlans, GPOS_ARRAY_SIZE(rgszSamplePlans),
...
CEnumeratorTest::EresUnittest_RunCompatibleDistributions()
{
	...
	return CTestUtils::EresRunMinidumps(mp, rgszCompatibleDistributions, ulTests,
...
//---------------------------------------------------------------------------
GPOS_RESULT
CEnumeratorTest::EresUnittest_CheckPlans(EOptTraceFlag eopttrace, FnPlanChecker *pfpc,
...
CEnumeratorTest::EresUnittest_CheckNoMotions()
{
	return EresUnittest_CheckPlans(EopttraceDisableMotions, FHasNoMotions,
								   &m_ulSamplingTestNoMotions, rgszCheckPlansNoMotions,
...
CEnumeratorTest::EresUnittest_CheckNoMotionBroadcast()
{
	return EresUnittest_CheckPlans(
		EopttraceDisableMotionBroadcast, FHasNoMotionBroadcast, &m_ulSamplingTestNoMotionBroadcast,
		rgszCheckPlansNoMotionBroadcast, GPOS_ARRAY_SIZE(rgszCheckPlansNoMotionBroadcast));
}
...
CEnumeratorTest::EresUnittest_CheckNoMotionGather()
{
	return EresUnittest_CheckPlans(EopttraceDisableMotionGather, FHasNoMotionGather,
...
CEnumeratorTest::EresUnittest_CheckNoSort()
{
	return EresUnittest_CheckPlans(EopttraceDisableSort, FHasNoSort, &m_ulSamplingTestNoSort,
...
CEnumeratorTest::EresUnittest_CheckNoSpool()
{
	return EresUnittest_CheckPlans(EopttraceDisableSpool, FHasNoSpool, &m_ulSamplingTestNoSpool,
...
CEnumeratorTest::EresUnittest_CheckNoOneStageAgg()
{
	return EresUnittest_CheckPlans(EopttraceForceMultiStageAgg, FHasNoOneStageAgg,
