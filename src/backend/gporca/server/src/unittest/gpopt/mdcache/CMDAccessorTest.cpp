...
CMDAccessorTest::EresUnittest()
{
	CUnittest rgut[] = {GPOS_UNITTEST_FUNC(CMDAccessorTest::EresUnittest_Basic),
						...
						GPOS_UNITTEST_FUNC_THROW(CMDAccessorTest::EresUnittest_Negative, gpdxl::ExmaMD,
...
CMDAccessorTest::EresUnittest_Basic()
{
	...
	CMDIdGPDB *pmdidObject1 =
		GPOS_NEW(mp) CMDIdGPDB(GPOPT_MDCACHE_TEST_OID /* OID */, 1 /* major version */, 1 /* minor version */);
	CMDIdGPDB *pmdidObject2 =
		GPOS_NEW(mp) CMDIdGPDB(GPOPT_MDCACHE_TEST_OID /* OID */, 12 /* version */, 1 /* minor version */);
	...
	const IMDScalarOp *md_scalar_op GPOS_ASSERTS_ONLY = mda.RetrieveScOp(mdid_op);
...
CMDAccessorTest::EresUnittest_Navigate()
{
	...
	CMDIdGPDB *mdid_func =
		GPOS_NEW(mp) CMDIdGPDB(GPDB_FUNC_TIMEOFDAY /* OID */, 1 /* major version */, 0 /* minor version */);
...
CMDAccessorTest::EresUnittest_Negative()
{
	...
	CMDIdGPDB *pmdidNonExistingObject =
		GPOS_NEW(mp) CMDIdGPDB(GPOPT_MDCACHE_TEST_OID /* OID */, 15 /* version */, 1 /* minor version */);
...
CMDAccessorTest::PvLookupMultipleObj(void *pv)
{
	...
	for (ULONG ul = 0; ul < ulNumberOfObjects; ul++)
	{
		...
		// lookup relation
		CMDIdGPDB *mdid =
			GPOS_NEW(pmdtaskparams->m_mp) CMDIdGPDB(GPOPT_MDCACHE_TEST_OID /*OID*/, 1 /*major*/, ul + 1 /*minor*/);
		(void) md_accessor->RetrieveRel(mdid);
		mdid->Release();
	}
