...
//---------------------------------------------------------------------------
CExpression *
CExpressionPreprocessorTest::PexprJoinHelper(CMemoryPool *mp, CExpression *pexprLOJ,
											 BOOL fCascadedLOJ, BOOL fIntermediateInnerjoin)
{
	...
	if (fIntermediateInnerjoin)
	{
		...
		pexprBottomJoin = GPOS_NEW(mp) CExpression(mp, GPOS_NEW(mp) CLogicalInnerJoin(mp),
	...
	if (fCascadedLOJ)
	{
		...
		pexprResult = GPOS_NEW(mp) CExpression(mp, GPOS_NEW(mp) CLogicalLeftOuterJoin(mp),
											   pexprBottomJoin, pexprGet, pexprEquality);
	}
...
//---------------------------------------------------------------------------
GPOS_RESULT
CExpressionPreprocessorTest::EresCompareExpressions(CMemoryPool *mp, CWStringDynamic *rgstr[],
													ULONG size)
{
			...
			for (ULONG ulPredCases = 0; ulPredCases < 2; ulPredCases++)
			{
					 ...
					 ulPredBelowWindowCases++)
				{
					...
					CExpression *pexprSelect = PexprWindowFuncWithLOJHelper(
						mp, pexprLOJ, colref, fAddWindowFunction, fOuterChildPred, fCascadedLOJ,
						fPredBelowWindow);
...
//---------------------------------------------------------------------------
void
CExpressionPreprocessorTest::PreprocessWinFuncWithDistinctAggs(CMemoryPool *mp,
...
CExpressionPreprocessorTest::EresUnittest_PreProcessWindowFuncWithDistinctAggs()
{
...

	{
		...
		{
			PreprocessWinFuncWithDistinctAggs(mp, rgszTestsDistinctAggsRemoveWindow[ul],
											  false /* fAllowSeqPrj */, false /* fAllowIDF */);
		}

		for (ULONG ul = 0; ul < GPOS_ARRAY_SIZE(rgszTestsDistinctAggsRemoveWindowINDF); ul++)
		{
			PreprocessWinFuncWithDistinctAggs(mp, rgszTestsDistinctAggsRemoveWindowINDF[ul],
											  false /* fAllowSeqPrj */, true /* fAllowIDF */);
		}

		for (ULONG ul = 0; ul < GPOS_ARRAY_SIZE(rgszTestsDistinctAggsDoNotRemoveWindow); ul++)
		{
			PreprocessWinFuncWithDistinctAggs(mp, rgszTestsDistinctAggsDoNotRemoveWindow[ul],
...
CExpressionPreprocessorTest::EresUnittest_UnnestSubqueries()
{
	...
	SUnnestSubqueriesTestCase rgunnesttc[] = {
		{CTestUtils::PexprScalarCmpIdentToConstant, CTestUtils::PexprScalarCmpIdentToConstant,
		 CScalarBoolOp::EboolopOr, COperator::EopSentinel, false},
		{CTestUtils::PexprScalarCmpIdentToConstant, CTestUtils::PexprScalarCmpIdentToConstant,
		 CScalarBoolOp::EboolopAnd, COperator::EopSentinel, false},

		{CTestUtils::PexprScalarCmpIdentToConstant, CTestUtils::PexprScalarCmpIdentToConstant,
		 CScalarBoolOp::EboolopOr, COperator::EopSentinel, true},
		{CTestUtils::PexprScalarCmpIdentToConstant, CTestUtils::PexprScalarCmpIdentToConstant,
		 CScalarBoolOp::EboolopAnd, COperator::EopSentinel, true},

		{CTestUtils::PexprExistsSubquery, CTestUtils::PexprScalarCmpIdentToConstant,
		 CScalarBoolOp::EboolopOr, COperator::EopScalarSubqueryNotExists, false},
		{CTestUtils::PexprExistsSubquery, CTestUtils::PexprScalarCmpIdentToConstant,
		 CScalarBoolOp::EboolopAnd, COperator::EopScalarSubqueryNotExists, false},

		{CTestUtils::PexprNotExistsSubquery, CTestUtils::PexprScalarCmpIdentToConstant,
		 CScalarBoolOp::EboolopOr, COperator::EopScalarSubqueryExists, false},
		{CTestUtils::PexprNotExistsSubquery, CTestUtils::PexprScalarCmpIdentToConstant,
		 CScalarBoolOp::EboolopAnd, COperator::EopScalarSubqueryExists, false},

		{CTestUtils::PexprExistsSubquery, CTestUtils::PexprScalarCmpIdentToConstant,
		 CScalarBoolOp::EboolopOr, COperator::EopScalarSubqueryExists, true},
		{CTestUtils::PexprExistsSubquery, CTestUtils::PexprScalarCmpIdentToConstant,
		 CScalarBoolOp::EboolopAnd, COperator::EopScalarSubqueryExists, true},

		{CTestUtils::PexprNotExistsSubquery, CTestUtils::PexprScalarCmpIdentToConstant,
		 CScalarBoolOp::EboolopOr, COperator::EopScalarSubqueryNotExists, true},
		{CTestUtils::PexprNotExistsSubquery, CTestUtils::PexprScalarCmpIdentToConstant,
		 CScalarBoolOp::EboolopAnd, COperator::EopScalarSubqueryNotExists, true},
...
CExpressionPreprocessorTest::EresUnittest_PreProcessNestedScalarSubqueries()
{
	...
	CExpression *pexprSubqInner = GPOS_NEW(mp)
		CExpression(mp,
	...
	CExpression *pexprSubqOuter = GPOS_NEW(mp)
		CExpression(mp,
...
//---------------------------------------------------------------------------
GPOS_RESULT
CExpressionPreprocessorTest::EresUnittest_CollapseInnerJoinHelper(CMemoryPool *mp,
																  COperator *popJoin,
																  CExpression *rgpexpr[],
																  CDrvdPropRelational *rgpdprel[])
{
	...
	CExpression *pexprCmpLOJInner =
		CUtils::PexprScalarEqCmp(mp, rgpdprel[1]->GetOutputColumns()->PcrFirst(),
...
CExpressionPreprocessorTest::EresUnittest_PreProcessConvert2InPredicateDeepExpressionTree()
{
	...
	CExpression *pexprDisjunct = GPOS_NEW(mp) CExpression(
		mp, pscboolopOr, CUtils::PexprScalarEqCmp(mp, pcrLeft, CUtils::PexprScalarConstInt4(mp, 1)),
