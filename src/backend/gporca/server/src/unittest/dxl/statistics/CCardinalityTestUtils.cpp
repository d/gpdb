...
CBucket *
CCardinalityTestUtils::PbucketIntegerClosedLowerBound(CMemoryPool *mp, INT iLower, INT iUpper, CDouble frequency,
													  CDouble distinct)
{
...
CHistogram *
CCardinalityTestUtils::PhistInt4Remain(CMemoryPool *mp, ULONG num_of_buckets, CDouble dNDVPerBucket, BOOL fNullFreq,
...
CPoint *
CCardinalityTestUtils::PpointGeneric(CMemoryPool *mp, OID oid, CWStringDynamic *pstrEncodedValue, LINT value)
{
...
CPoint *
CCardinalityTestUtils::PpointNumeric(CMemoryPool *mp, CWStringDynamic *pstrEncodedValue, CDouble value)
{
	CMDAccessor *md_accessor = COptCtxt::PoctxtFromTLS()->Pmda();
