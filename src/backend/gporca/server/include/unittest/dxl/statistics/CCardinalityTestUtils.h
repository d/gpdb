...
public:
	...
	static CBucket *PbucketIntegerClosedLowerBound(CMemoryPool *mp, INT iLower, INT iUpper, CDouble,
												   CDouble);
	...
	static CBucket *PbucketInteger(CMemoryPool *mp, INT iLower, INT iUpper, BOOL is_lower_closed,
	...
	static CHistogram *PhistInt4Remain(CMemoryPool *mp, ULONG num_of_buckets, CDouble dNDVPerBucket,
	...
	static CPoint *PpointGeneric(CMemoryPool *mp, OID oid, CWStringDynamic *pstrValueEncoded,
								 LINT value);
