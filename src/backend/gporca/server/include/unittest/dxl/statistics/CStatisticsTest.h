...
private:
	...
	static void StatsFilterInt4(CMemoryPool *mp, ULONG colid, INT iLower, INT iUpper,
	...
	static void StatsFilterGeneric(CMemoryPool *mp, ULONG colid, OID oid,
								   ...
								   LINT lValUpper, CStatsPredPtrArry *pgrgpstatspred);
	...
	static CTableDescriptor *PtabdescTwoColumnSource(CMemoryPool *mp, const CName &nameTable,
