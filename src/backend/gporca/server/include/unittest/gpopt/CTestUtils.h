...
public:
	...
	static GPOS_RESULT EresRunMinidumps(CMemoryPool *mp, const CHAR *rgszFileNames[], ULONG ulTests,
										...
										BOOL fTestSpacePruning, const CHAR *szMDFilePath = NULL,
	...
	static GPOS_RESULT EresRunMinidumpsUsingOneMDFile(CMemoryPool *mp, const CHAR *szMDFilePath,
													  ...
													  INT iCmpSpaceSize, IConstExprEvaluator *pceeval = NULL);
	...
	static CColRefSetArray *createEquivalenceClasses(CMemoryPool *mp, CColRefSet *pcrs, INT setBoundary[]);
};	// class CTestUtils
