...
private:
	...
	static CRangeArray *Pdrgprng(CMemoryPool *mp, IMDId *mdid, const SRangeInfo rgRangeInfo[],
								 ULONG ulRanges);
	...
	static GPOS_RESULT EresUnittest_CIntervalFromScalarCmp(CMemoryPool *mp,
	...
	static GPOS_RESULT EresUnittest_CIntervalFromScalarBoolOp(CMemoryPool *mp,
															  CMDAccessor *md_accessor,
															  CColRef *colref);
