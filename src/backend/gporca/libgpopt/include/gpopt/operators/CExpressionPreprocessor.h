...
private:
	...
	static CExpression *PexprAddEqualityPreds(CMemoryPool *mp, CExpression *pexpr,
	...
	static CExpression *PexprRemoveCTEAnchors(CMemoryPool *mp, CExpression *pexpr);
	...
	static CExpression *PexprFromConstraints(CMemoryPool *mp, CExpression *pexpr,
											 CColRefSet *pcrsProcessed);
	...
	static void CollectJoinChildrenRecursively(CMemoryPool *mp, CExpression *pexpr,
	...
	static CExpression *PexprProjBelowSubquery(CMemoryPool *mp, CExpression *pexpr,
											   BOOL fUnderPrList);
	...
	static CExpression *PexprOuterJoinInferPredsFromOuterChildToInnerChild(CMemoryPool *mp,
																		   CExpression *pexpr,
																		   BOOL *pfAddedPredicates);
	...
	static CExpression *PexprPruneUnusedComputedCols(CMemoryPool *mp, CExpression *pexpr,
													 CColRefSet *pcrsReqd);

	// driver for pruning unused computed columns
	static CExpression *PexprPruneUnusedComputedColsRecursive(CMemoryPool *mp, CExpression *pexpr,
															  CColRefSet *pcrsReqd);

	// prune unused project elements from the project list of Project or GbAgg
	static CExpression *PexprPruneProjListProjectOrGbAgg(CMemoryPool *mp, CExpression *pexpr,
	...
	static CExpression *PexprScalarBoolOpConvert2In(CMemoryPool *mp,
