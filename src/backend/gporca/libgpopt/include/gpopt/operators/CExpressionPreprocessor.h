...
private:
	...
	typedef CHashMap<ULONG, CExpressionArray, gpos::HashValue<ULONG>, gpos::Equals<ULONG>, CleanupDelete<ULONG>,
					 CleanupRelease<CExpressionArray> >
		CTEPredsMap;

	// iterator for map of CTE id to collected predicates
	typedef CHashMapIter<ULONG, CExpressionArray, gpos::HashValue<ULONG>, gpos::Equals<ULONG>, CleanupDelete<ULONG>,
						 CleanupRelease<CExpressionArray> >
		CTEPredsMapIter;
	...
	// constraint property
	static CExpression *PexprScalarPredicates(CMemoryPool *mp, CPropConstraint *ppc, CColRefSet *pcrsNotNull,
...
public:
	// main driver
	static CExpression *PexprPreprocess(CMemoryPool *mp, CExpression *pexpr, CColRefSet *pcrsOutputAndOrderCols = NULL);
