...
protected:
	...
	static CPartIndexMap *PpimDeriveFromDynamicScan(
		CMemoryPool *mp, ULONG part_idx_id, IMDId *rel_mdid, CColRef2dArray *pdrgpdrgpcrPart,
		ULONG ulSecondaryPartIndexId, CPartConstraint *ppartcnstr, CPartConstraint *ppartcnstrRel,
