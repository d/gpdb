...
protected:
	...
	CColRefArray *PdrgpcrCreateMapping(CMemoryPool *mp, const CColumnDescriptorArray *pdrgpcoldesc, ULONG ulOpSourceId,
									   IMDId *mdid_table = NULL) const;
	...
	static CFunctionProp *PfpDeriveFromScalar(CMemoryPool *mp, CExpressionHandle &exprhdl, ULONG ulScalarIndex);
...
public:
	...
	virtual CExpression *PexprPartPred(CMemoryPool *mp, CExpressionHandle &exprhdl, CExpression *pexprInput,
