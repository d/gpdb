...
private:
	...
	typedef void(FnPushThru)(CMemoryPool *mp, CExpression *pexprLogical, CExpression *pexprConj,
	...
	static BOOL FSimplifySelectOnOuterJoin(CMemoryPool *mp, CExpression *pexprOuterJoin,
										   CExpression *pexprPred, CExpression **ppexprResult);

	static BOOL FSimplifySelectOnFullJoin(CMemoryPool *mp, CExpression *pexprFullJoin,
										  CExpression *pexprPred, CExpression **ppexprResult);
	...
	static void PushThruUnaryWithScalarChild(CMemoryPool *mp, CExpression *pexprLogical,
	...
	static void PushThruUnaryWithoutScalarChild(CMemoryPool *mp, CExpression *pexprLogical,
												CExpression *pexprConj, CExpression **ppexprResult);
	...
	static void SplitConjunctForSeqPrj(CMemoryPool *mp, CExpression *pexprSeqPrj,
	...
	static void PushThruJoin(CMemoryPool *mp, CExpression *pexprJoin, CExpression *pexprConj,
							 CExpression **ppexprResult);

	// push scalar expression through logical expression
	static void PushThru(CMemoryPool *mp, CExpression *pexprLogical, CExpression *pexprConj,
						 CExpression **ppexprResult);
	...
	static CExpression *PexprPullUpAndCombineProjects(CMemoryPool *mp, CExpression *pexpr,
													  BOOL *pfSuccess);

	// pull up project elements from the given projection expression that do not
	// exist in the given used columns set
	static CExpression *PexprPullUpProjectElements(CMemoryPool *mp, CExpression *pexpr,
