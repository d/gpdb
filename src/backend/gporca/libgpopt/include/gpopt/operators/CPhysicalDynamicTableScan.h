...
public:
	// ctors
	CPhysicalDynamicTableScan(CMemoryPool *mp, BOOL is_partial, const CName *pname, CTableDescriptor *ptabdesc,
							  ULONG ulOriginOpId, ULONG scan_id, CColRefArray *colref_array,
