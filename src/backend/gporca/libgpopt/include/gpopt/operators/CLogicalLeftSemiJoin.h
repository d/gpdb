...
public:
	...
	virtual CColRefSet *DeriveOutputColumns(CMemoryPool *mp, CExpressionHandle &hdl);
	...
	// derive statistics
	static IStatistics *PstatsDerive(CMemoryPool *mp, CStatsPredJoinArray *join_preds_stats,
