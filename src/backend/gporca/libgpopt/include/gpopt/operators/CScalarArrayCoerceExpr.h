...
public:
	// ctor
	CScalarArrayCoerceExpr(CMemoryPool *mp, IMDId *element_func, IMDId *result_type_mdid, INT type_modifier,
						   BOOL is_explicit, ECoercionForm dxl_coerce_format, INT location);
