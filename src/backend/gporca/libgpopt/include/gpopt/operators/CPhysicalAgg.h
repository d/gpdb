...
private:
	...
	CDistributionSpec *PdsRequiredGlobalAgg(CMemoryPool *mp, CExpressionHandle &exprhdl,
...
protected:
	...
	CDistributionSpec *PdsRequiredAgg(CMemoryPool *mp, CExpressionHandle &exprhdl,
									  CDistributionSpec *pdsInput, ULONG child_index,
...
public:
	...
	PdsRequired(CMemoryPool *mp, CExpressionHandle &exprhdl, CDistributionSpec *pdsRequired,
				...
				ULONG ulOptReq) const
	{
		return PdsRequiredAgg(mp, exprhdl, pdsRequired, child_index, ulOptReq, m_pdrgpcr,
							  m_pdrgpcrMinimal);
	}
