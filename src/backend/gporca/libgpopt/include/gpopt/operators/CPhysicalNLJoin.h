...
protected:
	...
	CPartitionPropagationSpec *PppsRequiredNLJoinChild(CMemoryPool *mp, CExpressionHandle &exprhdl,
...
public:
	...
	virtual COrderSpec *PosRequired(CMemoryPool *mp, CExpressionHandle &exprhdl, COrderSpec *posInput,
	...
	PppsRequired(CMemoryPool *mp, CExpressionHandle &exprhdl, CPartitionPropagationSpec *pppsRequired,
