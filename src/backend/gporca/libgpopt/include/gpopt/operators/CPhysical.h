...
protected:
	...
	static CPartitionPropagationSpec *PppsRequiredPushThru(CMemoryPool *mp, CExpressionHandle &exprhdl,
														   CPartitionPropagationSpec *pppsRequired, ULONG child_index);

	// pass partition propagation requirement to the children of an n-ary operator
	static CPartitionPropagationSpec *PppsRequiredPushThruNAry(CMemoryPool *mp, CExpressionHandle &exprhdl,
															   CPartitionPropagationSpec *pppsRequired,
															   ULONG child_index);

	// helper function for pushing unresolved partition propagation in unary
	// operators
	static CPartitionPropagationSpec *PppsRequiredPushThruUnresolvedUnary(CMemoryPool *mp, CExpressionHandle &exprhdl,
																		  CPartitionPropagationSpec *pppsRequired,
...
public:
	...
	virtual CPartIndexMap *PpimDerive(CMemoryPool *mp, CExpressionHandle &exprhdl, CDrvdPropCtxt *pdpctxt) const = 0;
