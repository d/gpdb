...
protected:
	...
	void ExtractColIdsAttno(CMemoryPool *mp, CColRefSet *pcrs, ULongPtrArray *colids,
...
public:
	...
	CLogicalDynamicGetBase(CMemoryPool *mp, const CName *pnameAlias, CTableDescriptor *ptabdesc,
						   ULONG scan_id, CColRefArray *colref_array,
