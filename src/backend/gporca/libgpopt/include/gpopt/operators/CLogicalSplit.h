...
public:
	...
	// ctor
	CLogicalSplit(CMemoryPool *mp, CColRefArray *pdrgpcrDelete, CColRefArray *pdrgpcrInsert,
	...
	{
		return PcrsReqdChildStats(mp, exprhdl, pcrsInput, exprhdl.DeriveUsedColumns(1),
								  child_index);
	}
