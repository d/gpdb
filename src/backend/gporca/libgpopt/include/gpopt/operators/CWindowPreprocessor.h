...
private:
	...
	static void SplitPrjList(CMemoryPool *mp, CExpression *pexprSeqPrj,
							 ...
							 CExpressionArray **ppdrgpexprOtherPrjElems, COrderSpecArray **ppdrgposOther,
	...
	static void SplitSeqPrj(CMemoryPool *mp, CExpression *pexprSeqPrj, CExpression **ppexprGbAgg,
							CExpression **ppexprOutputSeqPrj);

	// create a CTE with two consumers using the child expression of Sequence Project
	static void CreateCTE(CMemoryPool *mp, CExpression *pexprSeqPrj, CExpression **ppexprFirstConsumer,
