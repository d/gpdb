...
public:
	// ctor
	CPhysicalPartitionSelector(CMemoryPool *mp, ULONG scan_id, IMDId *mdid, CColRef2dArray *pdrgpdrgpcr,
	...
	virtual BOOL FProvidesReqdCols(CExpressionHandle &exprhdl, CColRefSet *pcrsRequired, ULONG ulOptReq) const;
	...
	virtual CPartIndexMap *PpimDerive(CMemoryPool *mp, CExpressionHandle &exprhdl, CDrvdPropCtxt *pdpctxt) const;
	...
	PopConvert(COperator *pop)
	{
		...
		GPOS_ASSERT(EopPhysicalPartitionSelector == pop->Eopid() || EopPhysicalPartitionSelectorDML == pop->Eopid());
