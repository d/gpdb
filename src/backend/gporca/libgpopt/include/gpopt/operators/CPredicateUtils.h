...
private:
	...
	static CExpression *PexprIndexLookupKeyOnLeft(CMemoryPool *mp, CMDAccessor *md_accessor,
	...
	static CExpression *PexprIndexLookupKeyOnRight(CMemoryPool *mp, CMDAccessor *md_accessor,
												   CExpression *pexprScalar,
												   const IMDIndex *pmdindex,
												   CColRefArray *pdrgpcrIndex,
												   CColRefSet *outer_refs);
	...
	static CExpression *PexprReplaceColsWithNulls(CMemoryPool *mp, CExpression *pexprScalar,
												  CColRefSet *pcrs);
...
public:
	...
	static CExpression *PexprEliminateSelfComparison(CMemoryPool *mp, CExpression *pexpr);
	...
	static CExpression *PexprINDFConjunction(CMemoryPool *mp, CColRefArray *pdrgpcrFirst,
	...
	static void CollectGrandChildrenUnionUnionAll(CMemoryPool *mp, CExpression *pexpr,
												  ULONG child_index,
	...
	static CExpression *PexprConjDisj(CMemoryPool *mp, CExpressionArray *Pdrgpexpr,
									  BOOL fConjunction);

	// create conjunction/disjunction of two expressions
	static CExpression *PexprConjDisj(CMemoryPool *mp, CExpression *pexprOne, CExpression *pexprTwo,
									  BOOL fConjunction);
	...
	static CExpressionArray *PdrgpexprExpandDisjuncts(CMemoryPool *mp,
	...
	static CExpressionArray *PdrgpexprExpandConjuncts(CMemoryPool *mp,
	...
	static BOOL IsDisjunctionOfRangeComparison(CMemoryPool *mp, CExpression *pexpr, CColRef *colref,
											   CColRefSet *pcrsAllowedRefs,
											   BOOL allowNotEqualPreds);

	// check if the given comparison type is one of the range comparisons, i.e.
	// LT, GT, LEq, GEq, Eq
	static BOOL FRangeComparison(CExpression *expr, CColRef *colref, CColRefSet *pcrsAllowedRefs,
								 BOOL allowNotEqualPreds);
	...
	static CExpression *PexprPartPruningPredicate(CMemoryPool *mp,
	...
	static CExpressionArray *PdrgpexprAppendConjunctsDedup(CMemoryPool *mp,
	...
	// scalar expression
	static CExpression *PexprPredicateCol(CMemoryPool *mp, CConstraint *pcnstr, CColRef *colref,
										  BOOL fUseConstraints);
	...
	static BOOL FValidSemiJoinCorrelations(CMemoryPool *mp, CExpression *pexprOuter,
	...
	static BOOL FSimpleEqualityUsingCols(CMemoryPool *mp, CExpression *pexprScalar,
										 CColRefSet *pcrs);

	// check if given expression is a valid index lookup predicate
	// return (modified) predicate suited for index lookup
	static CExpression *PexprIndexLookup(CMemoryPool *mp, CMDAccessor *md_accessor,
										 CExpression *pexpPred, const IMDIndex *pmdindex,
	...
	static void ExtractLikePredComponents(CExpression *pexprPred, CExpression **ppexprScIdent,
	...
	static BOOL FCompatibleIndexPredicate(CExpression *pexprPred, const IMDIndex *pmdindex,
