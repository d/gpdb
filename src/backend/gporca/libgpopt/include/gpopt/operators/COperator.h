...
typedef CHashMap<CColRef, CColRef, CColRef::HashValue, CColRef::Equals, CleanupNULL<CColRef>, CleanupNULL<CColRef> >
	ColRefToColRefMap;
...
protected:
	...
	static IMDFunction::EFuncDataAcc EfdaDeriveFromChildren(CExpressionHandle &exprhdl,
