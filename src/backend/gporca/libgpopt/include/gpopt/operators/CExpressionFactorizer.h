...
private:
	...
	typedef CHashMap<ULONG, CExpressionArrays, gpos::HashValue<ULONG>, gpos::Equals<ULONG>,
					 CleanupDelete<ULONG>, CleanupRelease<CExpressionArrays> >
		SourceToArrayPosMap;

	// iterator for map of operator to disjunctive form representation
	typedef CHashMapIter<ULONG, CExpressionArrays, gpos::HashValue<ULONG>, gpos::Equals<ULONG>,
						 CleanupDelete<ULONG>, CleanupRelease<CExpressionArrays> >
	...
	typedef CHashMap<CColRef, CExpressionArrays, gpos::HashPtr<CColRef>, gpos::EqualPtr<CColRef>,
	...
	typedef CExpression *(*PexprProcessDisj)(CMemoryPool *mp, CExpression *pexpr,
	...
	static void AddFactor(CMemoryPool *mp, CExpression *pexpr, CExpressionArray *pdrgpexprFactors,
						  CExpressionArray *pdrgpexprResidual, ExprMap *pexprmap,
						  ULONG ulDisjuncts);
	...
	static BOOL FOpSourceIdOrComputedColumn(CExpression *pexpr, ULONG *ulOpSourceId,
	...
	static CExpressionArrays *PdrgPdrgpexprDisjunctArrayForSourceId(CMemoryPool *mp,
	...
	// or construct a new array and add it to the map
	static CExpressionArrays *PdrgPdrgpexprDisjunctArrayForColumn(CMemoryPool *mp,
	...
	static void StoreBaseOpToColumnExpr(CMemoryPool *mp, CExpression *pexpr,
										SourceToArrayPosMap *psrc2array,
										ColumnToArrayPosMap *pcol2array,
	...
	// of the given maps
	static CExpression *PexprAddInferredFilters(CMemoryPool *mp, CExpression *pexpr,
												SourceToArrayPosMap *psrc2array,
												ColumnToArrayPosMap *pcol2array);
	...
	static CExpression *PexprExtractInferredFiltersFromDisj(
		CMemoryPool *mp, CExpression *pexpr, CExpression *pexprLowestLogicalAncestor);
