...
protected:
	...
	public:
		// ctor
		CPartPropReq(CPartitionPropagationSpec *pppsRequired, ULONG child_index, ULONG ulOuterChild, ULONG ulInnerChild,
					 ULONG ulScalarChild)
	...
	typedef CHashMap<CPartPropReq, CPartitionPropagationSpec, CPartPropReq::HashValue, CPartPropReq::Equals,
					 CleanupRelease<CPartPropReq>, CleanupRelease<CPartitionPropagationSpec> >
	...
	CPartPropReq *PpprCreate(CMemoryPool *mp, CExpressionHandle &exprhdl, CPartitionPropagationSpec *pppsRequired,
							 ULONG child_index);
	...
	static void AddFilterOnPartKey(CMemoryPool *mp, BOOL fNLJoin, CExpression *pexprScalar, CPartIndexMap *ppimSource,
	...
	static CExpression *PexprJoinPredOnPartKeys(CMemoryPool *mp, CExpression *pexprScalar, CPartIndexMap *ppimSource,
