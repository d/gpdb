...
protected:
	...
	public:
		// ctor
		CPartPropReq(CPartitionPropagationSpec *pppsRequired, ULONG child_index, ULONG ulOuterChild,
					 ULONG ulInnerChild, ULONG ulScalarChild)
	...
	typedef CHashMap<CPartPropReq, CPartitionPropagationSpec, CPartPropReq::HashValue,
					 CPartPropReq::Equals, CleanupRelease<CPartPropReq>,
	...
	CDistributionSpec *PdsRequiredCorrelatedJoin(CMemoryPool *mp, CExpressionHandle &exprhdl,
	...
	CRewindabilitySpec *PrsRequiredCorrelatedJoin(CMemoryPool *mp, CExpressionHandle &exprhdl,
	...
	CPartitionPropagationSpec *PppsRequiredCompute(CMemoryPool *mp, CExpressionHandle &exprhdl,
	...
	CPartitionPropagationSpec *PppsRequiredJoinChild(CMemoryPool *mp, CExpressionHandle &exprhdl,
													 CPartitionPropagationSpec *pppsRequired,
													 ULONG child_index, CDrvdPropArray *pdrgpdpCtxt,
													 BOOL fNLJoin);

	// helper for propagating required sort order to outer child
	static COrderSpec *PosPropagateToOuter(CMemoryPool *mp, CExpressionHandle &exprhdl,
	...
	static void AddFilterOnPartKey(CMemoryPool *mp, BOOL fNLJoin, CExpression *pexprScalar,
	...
	static CExpression *PexprJoinPredOnPartKeys(CMemoryPool *mp, CExpression *pexprScalar,
												CPartIndexMap *ppimSource, ULONG part_idx_id,
												CColRefSet *pcrsAllowedRefs);

	// Do each of the given predicate children use columns from a different
	// join child?
	static BOOL FPredKeysSeparated(CExpression *pexprOuter, CExpression *pexprInner,
...
public:
	...
	static BOOL FHashJoinCompatible(CExpression *pexprPred, CExpression *pexprOuter,
									CExpression *pexprInner);

	// is given predicate merge-join compatible
	static BOOL FMergeJoinCompatible(CExpression *pexprPred, CExpression *pexprOuter,
									 CExpression *pexprInner);

	// return number of distribution requests for correlated join
	static ULONG UlDistrRequestsForCorrelatedJoin();

	static void AlignJoinKeyOuterInner(CExpression *pexprConjunct, CExpression *pexprOuter,
									   CExpression *pexprInner, CExpression **ppexprKeyOuter,
									   CExpression **ppexprKeyInner, IMDId **mdid_scop);

	static CRewindabilitySpec *PrsRequiredForNLJoinOuterChild(CMemoryPool *pmp,
