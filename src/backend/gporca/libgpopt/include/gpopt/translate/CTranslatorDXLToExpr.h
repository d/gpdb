...
private:
	...
	CColRef *PcrCreate(const CColRef *colref, const IMDType *pmdtype, INT type_modifier, BOOL fStoreMapping,
					   ULONG colid);
	...
	void AddDistributionColumns(CTableDescriptor *ptabdesc, const IMDRelation *pmdrel,
