...
private:
	...
	CExpression *PexprScalarSubqueryQuantified(Edxlopid edxlopid, IMDId *scalar_op_mdid,
	...
	CExpression *PexprCastPrjElem(IMDId *pmdidSource, IMDId *mdid_dest, const CColRef *pcrToCast,
								  CColRef *pcrToReturn);
	...
	CColRef *PcrCreate(const CColRef *colref, const IMDType *pmdtype, INT type_modifier,
