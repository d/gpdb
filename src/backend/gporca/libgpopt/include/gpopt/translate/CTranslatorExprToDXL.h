...
typedef CHashMap<CColRef, CDXLNode, gpos::HashValue<CColRef>, gpos::Equals<CColRef>, CleanupNULL<CColRef>,
...
private:
	...
	// translate a bitmap table scan expression to DXL
	CDXLNode *PdxlnBitmapTableScan(CExpression *pexprBitmapTableScan, CColRefSet *pcrsOutput,
	...
	CDXLNode *PdxlnPartitionSelectorWithInlinedCondition(CExpression *pexprFilter, CColRefArray *colref_array,
														 CDistributionSpecArray *pdrgpdsBaseTables,
	...
	CDXLNode *PdxlnTblScanFromNLJoinOuter(CExpression *pexprRelational, CDXLNode *pdxlnScalar,
										  CColRefArray *colref_array, CDistributionSpecArray *pdrgpdsBaseTables,
										  ULONG *pulNonGatherMotions, CDXLPhysicalProperties *dxl_properties);

	CDXLNode *PdxlnResultFromNLJoinOuter(CExpression *pexprRelational, CDXLNode *pdxlnScalar,
										 CColRefArray *colref_array, CDistributionSpecArray *pdrgpdsBaseTables,
										 ULONG *pulNonGatherMotions, BOOL *pfDML,
										 CDXLPhysicalProperties *dxl_properties);
	...
	CDXLNode *PdxlnPartitionSelectorDML(CExpression *pexpr, CColRefArray *pdrgpc,
										CDistributionSpecArray *pdrgpdsBaseTables, ULONG *pulNonGatherMotions,
										BOOL *pfDMLr);

	// translate an expansion-based partition selector with a scalar condition to inline
	CDXLNode *PdxlnPartitionSelectorExpand(CExpression *pexpr, CColRefArray *colref_array,
										   CDistributionSpecArray *pdrgpdsBaseTables, ULONG *pulNonGatherMotions,
	...
	CDXLNode *PdxlnPartitionSelectorFilter(CExpression *pexpr, CColRefArray *colref_array,
										   CDistributionSpecArray *pdrgpdsBaseTables, ULONG *pulNonGatherMotions,
										   BOOL *pfDML, CExpression *pexprScalarCond,
										   CDXLPhysicalProperties *dxl_properties);

	// translate partition selector filters
	void TranslatePartitionFilters(CExpression *pexprPartSelector, BOOL fPassThrough, CDXLNode **ppdxlnEqFilters,
								   CDXLNode **ppdxlnFilters, CDXLNode **ppdxlnResidual);

	// construct the level filter lists for partition selector
	void ConstructLevelFilters4PartitionSelector(CExpression *pexprPartSelector, CDXLNode **ppdxlnEqFilters,
	...
	CDXLNode *PdxlnPredOnPartKey(CExpression *pexprPred, CColRef *pcrPartKey, IMDId *pmdidTypePartKey,
								 ULONG ulPartLevel, BOOL fRangePart, BOOL *pfLTComparison, BOOL *pfGTComparison,
								 BOOL *pfEQComparison);

	// translate a conjunctive or disjunctive predicate on a part key and update the various
	// comparison type flags accordingly
	CDXLNode *PdxlnConjDisjOnPartKey(CExpression *pexprPred, CColRef *pcrPartKey, IMDId *pmdidTypePartKey,
									 ULONG ulPartLevel, BOOL fRangePart, BOOL *pfLTComparison, BOOL *pfGTComparison,
									 BOOL *pfEQComparison);

	// translate a scalar comparison on a part key and update the various
	// comparison type flags accordingly
	CDXLNode *PdxlnScCmpPartKey(CExpression *pexprScCmp, CColRef *pcrPartKey, IMDId *pmdidTypePartKey,
								ULONG ulPartLevel, BOOL fRangePart, BOOL *pfLTComparison, BOOL *pfGTComparison,
								BOOL *pfEQComparison);

	// translate a scalar null test on a part key
	CDXLNode *PdxlnScNullTestPartKey(IMDId *pmdidTypePartKey, ULONG ulPartLevel, BOOL fRangePart, BOOL is_null);

	// translate the child of a partition selector expression, pushing the given
	// scalar predicate if available
	CDXLNode *PdxlnPartitionSelectorChild(CExpression *pexprChild, CExpression *pexprScalarCond,
										  CDXLPhysicalProperties *dxl_properties, CColRefArray *colref_array,
										  CDistributionSpecArray *pdrgpdsBaseTables, ULONG *pulNonGatherMotions,
										  BOOL *pfDML);

	CDXLNode *PdxlArrayExprOnPartKey(CExpression *pexprPred, CColRef *pcrPartKey, IMDId *pmdidTypePartKey,
	...
	CDXLNode *PdxlnRowTrigger(CExpression *pexpr, CColRefArray *colref_array, CDistributionSpecArray *pdrgpdsBaseTables,
							  ULONG *pulNonGatherMotions, BOOL *pfDML);
	...
	CColRefArray *PdrgpcrMerge(CMemoryPool *mp, CColRefArray *pdrgpcrOrder, CColRefArray *pdrgpcrRequired);
