...
private:
	...
	CDXLNode *PdxlnPartitionSelectorWithInlinedCondition(CExpression *pexprFilter,
														 CColRefArray *colref_array,
														 CDistributionSpecArray *pdrgpdsBaseTables,
														 ULONG *pulNonGatherMotions, BOOL *pfDML);
	...
	CDXLNode *PdxlnScBoolExpr(EdxlBoolExprType boolexptype, CDXLNode *dxlnode_left,
	...
	void TranslatePartitionFilters(CExpression *pexprPartSelector, BOOL fPassThrough,
	...
	CDXLNode *PdxlnPredOnPartKey(CExpression *pexprPred, CColRef *pcrPartKey,
								 ...
								 BOOL *pfLTComparison, BOOL *pfGTComparison, BOOL *pfEQComparison);

	// translate a conjunctive or disjunctive predicate on a part key and update the various
	// comparison type flags accordingly
	CDXLNode *PdxlnConjDisjOnPartKey(CExpression *pexprPred, CColRef *pcrPartKey,
									 IMDId *pmdidTypePartKey, ULONG ulPartLevel, BOOL fRangePart,
									 BOOL *pfLTComparison, BOOL *pfGTComparison,
									 BOOL *pfEQComparison);
	...
	CDXLNode *PdxlnScNullTestPartKey(IMDId *pmdidTypePartKey, ULONG ulPartLevel, BOOL fRangePart,
									 BOOL is_null);
	...
	CDXLNode *PdxlArrayExprOnPartKey(CExpression *pexprPred, CColRef *pcrPartKey,
									 IMDId *pmdidTypePartKey, ULONG ulPartLevel, BOOL fRangePart,
	...
	CDXLNode *PdxlnCTAS(CExpression *pexpr, CDistributionSpecArray *pdrgpdsBaseTables,
						ULONG *pulNonGatherMotions, BOOL *pfDML);
	...
	CDXLNode *PdxlnResult(CDXLPhysicalProperties *dxl_properties, CDXLNode *pdxlnPrL,
	...
	// in subplan map
	void BuildScalarSubplans(CColRefArray *pdrgpcrInner, CExpression *pexprInner,
							 CDXLColRefArray *dxl_colref_array,
							 CDistributionSpecArray *pdrgpdsBaseTables, ULONG *pulNonGatherMotions,
							 BOOL *pfDML);
