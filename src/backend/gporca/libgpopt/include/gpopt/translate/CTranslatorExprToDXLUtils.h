...
private:
	...
	static CDXLNode *PdxlnCmp(CMemoryPool *mp, CMDAccessor *md_accessor, ULONG ulPartLevel,
	...
	static CColRef *PcrCreate(CMemoryPool *mp, CMDAccessor *md_accessor,
							  CColumnFactory *col_factory, IMDId *mdid, INT type_modifier,
							  const WCHAR *wszName);

	// find the partitioning level of the given part key, given the whole
	// array of part keys
	static ULONG UlPartKeyLevel(const CColRef *colref, CColRef2dArray *pdrgpdrgpcr);

	// construct a test for a partial scan given a part constraint
	static CDXLNode *PdxlnPartialScanTest(CMemoryPool *mp, CMDAccessor *md_accessor,
	...
	static CDXLNode *PdxlnPartialScanTestConjDisj(CMemoryPool *mp, CMDAccessor *md_accessor,
	...
	static CDXLNode *PdxlnPartialScanTestConjunction(CMemoryPool *mp, CMDAccessor *md_accessor,
													 CColumnFactory *col_factory,
													 CConstraint *pcnstr,
													 CColRef2dArray *pdrgpdrgpcrPartKeys,
													 BOOL fRangePart);
	...
	static CDXLNode *PdxlnPartialScanTestDisjunction(CMemoryPool *mp, CMDAccessor *md_accessor,
													 CColumnFactory *col_factory,
													 CConstraint *pcnstr,
													 CColRef2dArray *pdrgpdrgpcrPartKeys,
													 BOOL fRangePart);
	...
	static CDXLNode *PdxlnPartialScanTestNegation(CMemoryPool *mp, CMDAccessor *md_accessor,
												  CColumnFactory *col_factory, CConstraint *pcnstr,
												  CColRef2dArray *pdrgpdrgpcrPartKeys,
												  BOOL fRangePart);

	// construct a test for an interval-based part constraint
	static CDXLNode *PdxlnPartialScanTestInterval(CMemoryPool *mp, CMDAccessor *md_accessor,
												  CConstraint *pcnstr,
												  CColRef2dArray *pdrgpdrgpcrPartKeys,
												  BOOL fRangePart);

	// construct a test for a range in a part constraint
	static CDXLNode *PdxlnPartialScanTestRange(CMemoryPool *mp, CMDAccessor *md_accessor,
	...
	// start of the range
	static CDXLNode *PdxlnRangeStartPredicate(CMemoryPool *mp, CMDAccessor *md_accessor,
	...
	// construct a test for testing range containment with respect to the
	// end of the range
	static CDXLNode *PdxlnRangeEndPredicate(CMemoryPool *mp, CMDAccessor *md_accessor,
											IDatum *datum, CRange::ERangeInclusion eri,
											IMDId *pmdidPartKeyType, ULONG ulPartLevel);
	...
	static CDXLNode *PdxlnRangePointPredicate(CMemoryPool *mp, CMDAccessor *md_accessor,
											  IDatum *datum, CRange::ERangeInclusion eri,
	...
	static CDXLNode *PdxlnDefaultPartitionTest(CMemoryPool *mp, ULONG ulPartLevel);

	// compute a DXL datum from a point constraint
	static CDXLDatum *PdxldatumFromPointConstraint(CMemoryPool *mp, CMDAccessor *md_accessor,
	...
	static CDXLDatum2dArray *PdrgpdrgpdxldatumFromDisjPointConstraint(CMemoryPool *mp,
	...
	static CDXLDirectDispatchInfo *GetDXLDirectDispatchInfo(CMemoryPool *mp,
															CMDAccessor *md_accessor,
	...
	static CDXLDirectDispatchInfo *PdxlddinfoSingleDistrKey(CMemoryPool *mp,
															CMDAccessor *md_accessor,
...
public:
	...
	static CDXLNode *PdxlnBoolConst(CMemoryPool *mp, CMDAccessor *md_accessor, BOOL value);

	// create a scalar const value expression for the given int4 value
	static CDXLNode *PdxlnInt4Const(CMemoryPool *mp, CMDAccessor *md_accessor, INT val);

	// construct a filter node for a list partition predicate
	static CDXLNode *PdxlnListFilterScCmp(CMemoryPool *mp, CMDAccessor *md_accessor,
	...
	static CDXLNode *PdxlnListFilterPartKey(CMemoryPool *mp, CMDAccessor *md_accessor,
	...
	static CDXLNode *PdxlnRangeFilterEqCmp(CMemoryPool *mp, CMDAccessor *md_accessor,
										   CDXLNode *pdxlnScalar, IMDId *pmdidTypePartKey,
										   IMDId *pmdidTypeOther, IMDId *pmdidTypeCastExpr,
										   IMDId *mdid_cast_func, ULONG ulPartLevel);

	// construct a predicate for the lower or upper bound of a partition
	static CDXLNode *PdxlnRangeFilterPartBound(CMemoryPool *mp, CMDAccessor *md_accessor,
											   CDXLNode *pdxlnScalar, IMDId *pmdidTypePartKey,
											   IMDId *pmdidTypeOther, IMDId *pmdidTypeCastExpr,
											   IMDId *mdid_cast_func, ULONG ulPartLevel,
	...
	static CDXLNode *PdxlnRangeFilterDefaultAndOpenEnded(CMemoryPool *mp, ULONG ulPartLevel,
	...
	static CDXLNode *PdxlnPrLPartitionSelector(CMemoryPool *mp, CMDAccessor *md_accessor,
											   CColumnFactory *col_factory,
											   ColRefToDXLNodeMap *phmcrdxln,
	...
	static CDXLNode *PdxlnPropExprPartitionSelector(CMemoryPool *mp, CMDAccessor *md_accessor,
	...
	static void ReplaceSubplan(CMemoryPool *mp, ColRefToDXLNodeMap *phmcrdxlnSubplans,
							   const CColRef *colref, CDXLScalarProjElem *pdxlopPrEl);

	// create a project elem from a given col ref
	static CDXLNode *PdxlnProjElem(CMemoryPool *mp, ColRefToDXLNodeMap *phmcrdxlnSubplans,
	...
	static CColRefArray *PdrgpcrMapColumns(CMemoryPool *mp, CColRefArray *pdrgpcrInput,
										   ColRefToUlongMap *phmcrul, CColRefArray *pdrgpcrMapDest);

	// combine two boolean expressions using the given boolean operator
	static CDXLNode *PdxlnCombineBoolean(CMemoryPool *mp, CDXLNode *first_child_dxlnode,
										 CDXLNode *second_child_dxlnode,
										 EdxlBoolExprType boolexptype);

	// construct a partition selector node
	static CDXLNode *PdxlnPartitionSelector(CMemoryPool *mp, IMDId *mdid, ULONG ulPartLevels,
											ULONG scan_id, CDXLPhysicalProperties *dxl_properties,
	...
	static CDXLNode *PdxlnResult(CMemoryPool *mp, CDXLPhysicalProperties *dxl_properties,
								 CDXLNode *pdxlnPrL, CDXLNode *filter_dxlnode,
								 CDXLNode *one_time_filter, CDXLNode *child_dxlnode);

	// create a DXL ValuesScan node
	static CDXLNode *PdxlnValuesScan(CMemoryPool *mp, CDXLPhysicalProperties *dxl_properties,
	...
	static void SetStats(CMemoryPool *mp, CMDAccessor *md_accessor, CDXLNode *dxlnode,
						 const IStatistics *stats, BOOL fRoot);

	// set direct dispatch info of the operator
	static void SetDirectDispatchInfo(CMemoryPool *mp, CMDAccessor *md_accessor, CDXLNode *dxlnode,
									  CExpression *pexpr,
	...
	static BOOL FMotionHazard(CMemoryPool *mp, CDXLNode *dxlnode, const gpdxl::Edxlopid *peopid,
