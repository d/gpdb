...
private:
	...
	static CDXLNode *PdxlnCmp(CMemoryPool *mp, CMDAccessor *md_accessor, ULONG ulPartLevel, BOOL fLowerBound,
	...
	static CDXLNode *PdxlnPartialScanTest(CMemoryPool *mp, CMDAccessor *md_accessor, CColumnFactory *col_factory,
	...
	static CDXLNode *PdxlnPartialScanTestInterval(CMemoryPool *mp, CMDAccessor *md_accessor, CConstraint *pcnstr,
												  CColRef2dArray *pdrgpdrgpcrPartKeys, BOOL fRangePart);

	// construct a test for a range in a part constraint
	static CDXLNode *PdxlnPartialScanTestRange(CMemoryPool *mp, CMDAccessor *md_accessor, CRange *prng,
	...
	// start of the range
	static CDXLNode *PdxlnRangeStartPredicate(CMemoryPool *mp, CMDAccessor *md_accessor, IDatum *datum,
											  CRange::ERangeInclusion eri, IMDId *pmdidPartKeyType, ULONG ulPartLevel);


	// construct a test for testing range containment with respect to the
	// end of the range
	static CDXLNode *PdxlnRangeEndPredicate(CMemoryPool *mp, CMDAccessor *md_accessor, IDatum *datum,
											CRange::ERangeInclusion eri, IMDId *pmdidPartKeyType, ULONG ulPartLevel);

	// construct a test for testing range containment with respect to the
	// given point in the range using the provided inclusion (<= or >=)
	// and exclusion comparison operators (< or >)
	static CDXLNode *PdxlnRangePointPredicate(CMemoryPool *mp, CMDAccessor *md_accessor, IDatum *datum,
											  CRange::ERangeInclusion eri, IMDId *pmdidPartKeyType, IMDId *pmdidCmpExcl,
...
public:
	...
	static CDXLNode *PdxlnListFilterScCmp(CMemoryPool *mp, CMDAccessor *md_accessor, CDXLNode *pdxlnPartKey,
	...
	static CDXLNode *PdxlnListFilterPartKey(CMemoryPool *mp, CMDAccessor *md_accessor, CExpression *pexprPartKey,
											IMDId *pmdidTypePartKey, ULONG ulPartLevel);

	// construct a filter node for a range predicate
	static CDXLNode *PdxlnRangeFilterScCmp(CMemoryPool *mp, CMDAccessor *md_accessor, CDXLNode *pdxlnScalar,
	...
	static CDXLNode *PdxlnRangeFilterEqCmp(CMemoryPool *mp, CMDAccessor *md_accessor, CDXLNode *pdxlnScalar,
										   IMDId *pmdidTypePartKey, IMDId *pmdidTypeOther, IMDId *pmdidTypeCastExpr,
										   IMDId *mdid_cast_func, ULONG ulPartLevel);

	// construct a predicate for the lower or upper bound of a partition
	static CDXLNode *PdxlnRangeFilterPartBound(CMemoryPool *mp, CMDAccessor *md_accessor, CDXLNode *pdxlnScalar,
											   IMDId *pmdidTypePartKey, IMDId *pmdidTypeOther, IMDId *pmdidTypeCastExpr,
	...
	static CDXLNode *PdxlnRangeFilterDefaultAndOpenEnded(CMemoryPool *mp, ULONG ulPartLevel, BOOL fLTComparison,
	...
	static CDXLNode *PdxlnPropagationExpressionForPartConstraints(CMemoryPool *mp, CMDAccessor *md_accessor,
	...
	static CDXLNode *PdxlnPrLPartitionSelector(CMemoryPool *mp, CMDAccessor *md_accessor, CColumnFactory *col_factory,
	...
	static CDXLNode *PdxlnPartitionSelector(CMemoryPool *mp, IMDId *mdid, ULONG ulPartLevels, ULONG scan_id,
