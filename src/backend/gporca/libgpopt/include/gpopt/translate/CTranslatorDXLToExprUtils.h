...
public:
	...
	static CExpression *PexprConstInt8(CMemoryPool *mp, CMDAccessor *md_accessor, CSystemId sysid,
									   LINT liValue);
	...
	static CColRefArray *Pdrgpcr(CMemoryPool *mp, UlongToColRefMap *colref_mapping,
