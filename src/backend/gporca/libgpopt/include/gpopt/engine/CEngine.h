...
private:
	...
	gpos::owner<CExpression *> m_pexprEnforcerPattern;
	...
	gpos::owner<UlongPtrArray *> m_pdrgpulpXformCalls;

	// time consumed by each xform
	gpos::owner<UlongPtrArray *> m_pdrgpulpXformTimes;

	// number of bindings for each xform
	gpos::owner<UlongPtrArray *> m_pdrgpulpXformBindings;

	// number of alternatives generated by each xform
	gpos::owner<UlongPtrArray *> m_pdrgpulpXformResults;
	...
	static BOOL FChildrenOptimized(
	...
	static BOOL FPossibleDuplicateGroups(gpos::pointer<CGroup *> pgroupFst,
	...
	// propagation spec
	static BOOL FCheckReqdPartPropagation(
