...
private:
	...
	gpos::Ref<CExpression> m_pexprEnforcerPattern;
	...
	gpos::Ref<UlongPtrArray> m_pdrgpulpXformCalls;

	// time consumed by each xform
	gpos::Ref<UlongPtrArray> m_pdrgpulpXformTimes;

	// number of bindings for each xform
	gpos::Ref<UlongPtrArray> m_pdrgpulpXformBindings;

	// number of alternatives generated by each xform
	gpos::Ref<UlongPtrArray> m_pdrgpulpXformResults;
	...
	gpos::Ref<COptimizationContextArray> PdrgpocOptimizeChildren(
	...
	gpos::Ref<CExpression> PexprUnrank(ULLONG plan_id);
...
public:
	...
	gpos::Ref<CExpression> PexprExtractPlan();
	...
	gpos::Ref<COptimizationContextArray> PdrgpocChildren(
