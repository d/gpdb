...
class CXformInnerJoin2DynamicBitmapIndexGetApply
	: public CXformJoin2IndexApplyBase<CLogicalInnerJoin, CLogicalIndexApply, CLogicalDynamicGet, false /*fWithSelect*/,
...
public:
	...
	explicit CXformInnerJoin2DynamicBitmapIndexGetApply(CMemoryPool *mp)
		: CXformJoin2IndexApplyBase<CLogicalInnerJoin, CLogicalIndexApply, CLogicalDynamicGet, false /*fWithSelect*/,
