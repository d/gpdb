...
struct SPartDynamicIndexGetInfo
{
	...
	// ctor
	SPartDynamicIndexGetInfo(const IMDIndex *pmdindex, CPartConstraint *ppartcnstr, CExpressionArray *pdrgpexprIndex,
...
typedef CHashMap<CExpression, CExpressionArray, CExpression::HashValue, CUtils::Equals, CleanupRelease<CExpression>,
				 CleanupRelease<CExpressionArray> >
	ExprToExprArrayMap;

// iterator of map of expression to array of expressions
typedef CHashMapIter<CExpression, CExpressionArray, CExpression::HashValue, CUtils::Equals, CleanupRelease<CExpression>,
					 CleanupRelease<CExpressionArray> >
...
private:
	...
	typedef CLogical *(*PDynamicIndexOpConstructor)(CMemoryPool *mp, const IMDIndex *pmdindex,
	...
	typedef CExpression *(PRewrittenIndexPath)(CMemoryPool *mp, CExpression *pexprIndexCond,
											   CExpression *pexprResidualCond, const IMDIndex *pmdindex,
											   CTableDescriptor *ptabdesc, COperator *popLogical);
	...
	static CExpression *PexprBuildIndexPlan(CMemoryPool *mp, CMDAccessor *md_accessor, CExpression *pexprGet,
	...
	static CLogical *
	PopDynamicBtreeIndexOpConstructor(CMemoryPool *mp, const IMDIndex *pmdindex, CTableDescriptor *ptabdesc,
									  ULONG ulOriginOpId, CName *pname, ULONG ulPartIndex, CColRefArray *pdrgpcrOutput,
									  CColRef2dArray *pdrgpdrgpcrPart, ULONG ulSecondaryPartIndexId,
									  CPartConstraint *ppartcnstr, CPartConstraint *ppartcnstrRel)
	{
		return GPOS_NEW(mp)
			CLogicalDynamicIndexGet(mp, pmdindex, ptabdesc, ulOriginOpId, pname, ulPartIndex, pdrgpcrOutput,
									pdrgpdrgpcrPart, ulSecondaryPartIndexId, ppartcnstr, ppartcnstrRel);
	}

	//	create a static operator for a btree index plan
	static CLogical *
	PopStaticBtreeIndexOpConstructor(CMemoryPool *mp, const IMDIndex *pmdindex, CTableDescriptor *ptabdesc,
									 ULONG ulOriginOpId, CName *pname, CColRefArray *pdrgpcrOutput)
	{
		return GPOS_NEW(mp) CLogicalIndexGet(mp, pmdindex, ptabdesc, ulOriginOpId, pname, pdrgpcrOutput);
	}

	//	produce an expression representing a new btree index path
	static CExpression *
	PexprRewrittenBtreeIndexPath(CMemoryPool *mp, CExpression *pexprIndexCond, CExpression *pexprResidualCond,
	...
	static SPartDynamicIndexGetInfo *PpartdigDynamicGet(CMemoryPool *mp, CExpressionArray *pdrgpexprScalar,
	...
	static CExpression *PexprEqualityOnBoolColumn(CMemoryPool *mp, CMDAccessor *md_accessor, BOOL fNegated,
												  CColRef *colref);
...
public:
	...
	static BOOL FTriggersExist(CLogicalDML::EDMLOperator edmlop, CTableDescriptor *ptabdesc, BOOL fBefore);
	...
	static CExpression *PexprRowTrigger(CMemoryPool *mp, CExpression *pexprChild, CLogicalDML::EDMLOperator edmlop,
										IMDId *rel_mdid, BOOL fBefore, CColRefArray *colref_array);

	// construct a trigger expression on top of the given expression
	static CExpression *PexprRowTrigger(CMemoryPool *mp, CExpression *pexprChild, CLogicalDML::EDMLOperator edmlop,
										IMDId *rel_mdid, BOOL fBefore, CColRefArray *pdrgpcrOld,
	...
	static CExpression *PexprAssertUpdateCardinality(CMemoryPool *mp, CExpression *pexprDMLChild, CExpression *pexprDML,
	...
	static CColRefSet *PcrsIndexIncludedCols(CMemoryPool *mp, CColRefArray *colref_array, const IMDIndex *pmdindex,
											 const IMDRelation *pmdrel);
	...
	static CExpression *
	PexprLogicalIndexGet(CMemoryPool *mp, CMDAccessor *md_accessor, CExpression *pexprGet, ULONG ulOriginOpId,
	...
	{
		return PexprBuildIndexPlan(mp, md_accessor, pexprGet, ulOriginOpId, pdrgpexprConds, pcrsReqd, pcrsScalarExpr,
								   outer_refs, pmdindex, pmdrel, fAllowPartialIndex, ppcartcnstrIndex,
	...
	static CExpression *PexprScalarBitmapBoolOp(CMemoryPool *mp, CMDAccessor *md_accessor,
	...
	static SPartDynamicIndexGetInfoArrays *PdrgpdrgppartdigCandidates(
		...
		CColRef2dArray *pdrgpdrgpcrPartKey, const IMDRelation *pmdrel, CPartConstraint *ppartcnstrRel,
		CColRefArray *pdrgpcrOutput, CColRefSet *pcrsReqd, CColRefSet *pcrsScalarExpr,
	...
	static CPartConstraint *PpartcnstrUpdateCovered(CMemoryPool *mp, CMDAccessor *md_accessor,
	...
	static CExpression *PexprPartialDynamicIndexGet(
		CMemoryPool *mp, CLogicalDynamicGet *popGet, ULONG ulOriginOpId, CExpressionArray *pdrgpexprIndex,
		CExpressionArray *pdrgpexprResidual, CColRefArray *pdrgpcrDIG, const IMDIndex *pmdindex,
...
template <class T>
void
CXformUtils::TransformImplementBinaryOp(CXformContext *pxfctxt, CXformResult *pxfres, CExpression *pexpr)
{
...
template <class T>
void
CXformUtils::AddHashOrMergeJoinAlternative(CMemoryPool *mp, CExpression *pexprJoin, CExpressionArray *pdrgpexprOuter,
