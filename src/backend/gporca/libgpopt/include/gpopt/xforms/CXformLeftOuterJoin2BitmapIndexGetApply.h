...
class CXformLeftOuterJoin2BitmapIndexGetApply
	: public CXformJoin2IndexApplyBase<CLogicalLeftOuterJoin, CLogicalIndexApply, CLogicalGet, false /*fWithSelect*/,
...
public:
	...
	explicit CXformLeftOuterJoin2BitmapIndexGetApply(CMemoryPool *mp)
		: CXformJoin2IndexApplyBase<CLogicalLeftOuterJoin, CLogicalIndexApply, CLogicalGet, false /*fWithSelect*/,
