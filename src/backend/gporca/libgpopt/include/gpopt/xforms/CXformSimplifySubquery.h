...
private:
	...
	typedef BOOL(FnSimplify)(CMemoryPool *mp, CExpression *,
	...
	static gpos::Ref<CExpression> FSimplifySubquery(CMemoryPool *mp,
...
public:
	...
	// ctor
	explicit CXformSimplifySubquery(gpos::Ref<CExpression> pexprPattern);
