...
class CXformInnerJoin2BitmapIndexGetApply
	: public CXformJoin2IndexApplyBase<CLogicalInnerJoin, CLogicalIndexApply, CLogicalGet, false /*fWithSelect*/,
...
public:
	...
	explicit CXformInnerJoin2BitmapIndexGetApply(CMemoryPool *mp)
		: CXformJoin2IndexApplyBase<CLogicalInnerJoin, CLogicalIndexApply, CLogicalGet, false /*fWithSelect*/,
