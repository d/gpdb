...
private:
	...
	struct SExpressionProperties
	{
		...
		IsGreedy()
		{
			return 0 != (m_join_order &
						 (EJoinOrderQuery + EJoinOrderMincard + EJoinOrderGreedyAvoidXProd));
		}
	};
	...
	void PopulateDPEInfo(SExpressionInfo *join_expr_info, SGroupInfo *left_group_info,
...
public:
	...
	CJoinOrderDPv2(CMemoryPool *mp, CExpressionArray *pdrgpexprAtoms,
				   CExpressionArray *innerJoinConjuncts, CExpressionArray *onPredConjuncts,
