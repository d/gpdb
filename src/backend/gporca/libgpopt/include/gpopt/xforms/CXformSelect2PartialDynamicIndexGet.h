...
private:
	...
	CColRefSet *GetColRefSet(CMemoryPool *mp, CLogicalGet *popGet, const IMDIndex *pmdindex,
							 BOOL fIncludedColumns) const;

	// create an index get plan when applicable
	void CreatePartialIndexGetPlan(CMemoryPool *mp, CExpression *pexpr, SPartDynamicIndexGetInfoArray *pdrgppartdig,
	...
	static CExpression *PexprSelectOverDynamicGet(CMemoryPool *mp, CLogicalDynamicGet *popGet, CExpression *pexprScalar,
