...
private:
	...
	void CreateHomogeneousBtreeIndexApplyAlternatives(CMemoryPool *mp, ULONG ulOriginOpId, CExpression *pexprOuter,
													  CExpression *pexprInner, CExpression *pexprScalar,
													  CTableDescriptor *ptabdescInner,
													  CLogicalDynamicGet *popDynamicGet, CColRefSet *pcrsScalarExpr,
													  CColRefSet *outer_refs, CColRefSet *pcrsReqd, ULONG ulIndices,
													  CXformResult *pxfres) const;

	// helper to add IndexApply expression to given xform results container
	// for homogeneous b-tree indexes
	void CreateAlternativesForBtreeIndex(CMemoryPool *mp, ULONG ulOriginOpId, CExpression *pexprOuter,
	...
	void CreateHomogeneousBitmapIndexApplyAlternatives(CMemoryPool *mp, ULONG ulOriginOpId, CExpression *pexprOuter,
													   CExpression *pexprInner, CExpression *pexprScalar,
	...
	void ComputeColumnSets(CMemoryPool *mp, CExpression *pexprInner, CExpression *pexprScalar,
						   CColRefSet **ppcrsScalarExpr, CColRefSet **ppcrsOuterRefs, CColRefSet **ppcrsReqd) const;

	// create an index apply plan when applicable
	void CreatePartialIndexApplyPlan(CMemoryPool *mp, ULONG ulOriginOpId, CExpression *pexprOuter,
									 CExpression *pexprScalar, CColRefSet *outer_refs,
									 CLogicalDynamicGet *popDynamicGet, SPartDynamicIndexGetInfoArray *pdrgppartdig,
	...
	CExpression *PexprJoinOverCTEConsumer(CMemoryPool *mp, ULONG ulOriginOpId, CLogicalDynamicGet *popDynamicGet,
										  ULONG ulCTEId, CExpression *pexprScalar, CColRefArray *pdrgpcrDynamicGet,
	...
	CExpression *PexprIndexApplyOverCTEConsumer(CMemoryPool *mp, ULONG ulOriginOpId, CLogicalDynamicGet *popDynamicGet,
	...
	CExpression *PexprConstructUnionAll(CMemoryPool *mp, CColRefArray *pdrgpcrLeftSchema,
	...
	//	Xform result
	void AddUnionPlanForPartialIndexes(CMemoryPool *mp, CLogicalDynamicGet *popDynamicGet, ULONG ulCTEId,
									   CExpression *pexprUnion, CExpression *pexprScalar, CXformResult *pxfres) const;
...
protected:
	...
	virtual void CreateHomogeneousIndexApplyAlternatives(CMemoryPool *mp, ULONG ulOriginOpId, CExpression *pexprOuter,
														 CExpression *pexprInner, CExpression *pexprScalar,
														 CTableDescriptor *PtabdescInner,
	...
	// helper to add IndexApply expression to given xform results container
	// for partial indexes
	virtual void CreatePartialIndexApplyAlternatives(CMemoryPool *mp, ULONG ulOriginOpId, CExpression *pexprOuter,
													 CExpression *pexprInner, CExpression *pexprScalar,
	...
	virtual CLogicalApply *PopLogicalApply(CMemoryPool *mp, CColRefArray *pdrgpcrOuterRefs) const = 0;
