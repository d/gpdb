...
private:
	...
	void CreateHomogeneousBtreeIndexApplyAlternatives(
		...
		CExpression *pexprScalar, CTableDescriptor *ptabdescInner,
		CLogicalDynamicGet *popDynamicGet, CColRefSet *pcrsScalarExpr, CColRefSet *outer_refs,
	...
	CExpression *PexprJoinOverCTEConsumer(CMemoryPool *mp, ULONG ulOriginOpId,
	...
	CExpression *PexprIndexApplyOverCTEConsumer(
		...
		CColRefArray *pdrgpcrIndexGet, const IMDIndex *pmdindex, const IMDRelation *pmdrel,
		BOOL fFirst, ULONG ulCTEId, CPartConstraint *ppartcnstr, CColRefSet *outer_refs,
		CColRefArray *pdrgpcrOuter, CColRefArray *pdrgpcrOuterNew,
		CColRefArray *pdrgpcrOuterRefsInScan, ULongPtrArray *pdrgpulIndexesOfRefsInScan) const;
	...
	CExpression *PexprConstructUnionAll(CMemoryPool *mp, CColRefArray *pdrgpcrLeftSchema,
										...
										CExpression *pexprLeftChild, CExpression *pexprRightChild,
										ULONG scan_id) const;

	//	construct a CTE Anchor over the given UnionAll and adds it to the given
	//	Xform result
	void AddUnionPlanForPartialIndexes(CMemoryPool *mp, CLogicalDynamicGet *popDynamicGet,
									   ULONG ulCTEId, CExpression *pexprUnion,
									   CExpression *pexprScalar, CXformResult *pxfres) const;
...
protected:
	...
	virtual void CreatePartialIndexApplyAlternatives(
		CMemoryPool *mp, ULONG ulOriginOpId, CExpression *pexprOuter, CExpression *pexprInner,
		CExpression *pexprScalar, CTableDescriptor *PtabdescInner,
		CLogicalDynamicGet *popDynamicGet, CXformResult *pxfres) const;
