...
class CXformInnerJoinWithInnerSelect2BitmapIndexGetApply
	: public CXformJoin2IndexApplyBase<CLogicalInnerJoin, CLogicalIndexApply, CLogicalGet, true /*fWithSelect*/,
									   false /*is_partial*/, IMDIndex::EmdindBitmap>
{
private:
	// private copy ctor
	CXformInnerJoinWithInnerSelect2BitmapIndexGetApply(const CXformInnerJoinWithInnerSelect2BitmapIndexGetApply &);

public:
	// ctor
	explicit CXformInnerJoinWithInnerSelect2BitmapIndexGetApply(CMemoryPool *mp)
		: CXformJoin2IndexApplyBase<CLogicalInnerJoin, CLogicalIndexApply, CLogicalGet, true /*fWithSelect*/,
									false /*is_partial*/, IMDIndex::EmdindBitmap>(mp)
	{
	}
