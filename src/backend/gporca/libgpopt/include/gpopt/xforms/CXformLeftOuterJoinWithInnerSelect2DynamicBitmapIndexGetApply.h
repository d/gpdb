...
class CXformLeftOuterJoinWithInnerSelect2DynamicBitmapIndexGetApply
	: public CXformJoin2IndexApplyBase<CLogicalLeftOuterJoin, CLogicalIndexApply,
...
public:
	...
	explicit CXformLeftOuterJoinWithInnerSelect2DynamicBitmapIndexGetApply(CMemoryPool *mp)
		: CXformJoin2IndexApplyBase<CLogicalLeftOuterJoin, CLogicalIndexApply, CLogicalDynamicGet,
									true /*fWithSelect*/, false /*is_partial*/,
