...
class CXformInnerJoinWithInnerSelect2DynamicIndexGetApply
	: public CXformJoin2IndexApplyBase<CLogicalInnerJoin, CLogicalIndexApply, CLogicalDynamicGet, true /*fWithSelect*/,
									   false /*is_partial*/, IMDIndex::EmdindBtree>
{
private:
	// private copy ctor
	CXformInnerJoinWithInnerSelect2DynamicIndexGetApply(const CXformInnerJoinWithInnerSelect2DynamicIndexGetApply &);

public:
	// ctor
	explicit CXformInnerJoinWithInnerSelect2DynamicIndexGetApply(CMemoryPool *mp)
		: CXformJoin2IndexApplyBase<CLogicalInnerJoin, CLogicalIndexApply, CLogicalDynamicGet, true /*fWithSelect*/,
									false /*is_partial*/, IMDIndex::EmdindBtree>(mp)
	{
	}
