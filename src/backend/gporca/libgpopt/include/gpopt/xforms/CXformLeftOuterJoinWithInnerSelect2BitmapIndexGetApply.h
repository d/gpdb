...
class CXformLeftOuterJoinWithInnerSelect2BitmapIndexGetApply
	: public CXformJoin2IndexApplyBase<CLogicalLeftOuterJoin, CLogicalIndexApply, CLogicalGet,
...
public:
	...
	explicit CXformLeftOuterJoinWithInnerSelect2BitmapIndexGetApply(CMemoryPool *mp)
		: CXformJoin2IndexApplyBase<CLogicalLeftOuterJoin, CLogicalIndexApply, CLogicalGet,
									true /*fWithSelect*/, false /*is_partial*/,
