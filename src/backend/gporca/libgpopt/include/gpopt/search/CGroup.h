...
private:
	...
	typedef CHashMap<SContextLink, BOOL, SContextLink::HashValue, SContextLink::Equals, CleanupDelete<SContextLink>,
					 CleanupDelete<BOOL> >
		LinkMap;
	...
	CLogical::EStatPromise EspDerive(CMemoryPool *pmpLocal, CMemoryPool *pmpGlobal, CGroupExpression *pgexpr,
