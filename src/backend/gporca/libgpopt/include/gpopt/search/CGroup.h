...
typedef CHashMap<CReqdPropPlan, CCost, CReqdPropPlan::UlHashForCostBounding,
				 CReqdPropPlan::FEqualForCostBounding, CleanupRelease<CReqdPropPlan>,
				 CleanupDelete<CCost> >
...
private:
	...
	typedef CHashMap<COptimizationContext, IStatistics, COptimizationContext::UlHashForStats,
					 COptimizationContext::FEqualForStats, CleanupRelease<COptimizationContext>,
	...
	BOOL FBetterPromise(CMemoryPool *mp, CLogical::EStatPromise espFst, CGroupExpression *pgexprFst,
						CLogical::EStatPromise espSnd, CGroupExpression *pgexprSnd) const;

	// derive stats recursively on child groups
	CLogical::EStatPromise EspDerive(CMemoryPool *pmpLocal, CMemoryPool *pmpGlobal,
	...
	void RecursiveBuildTreeMap(CMemoryPool *mp, COptimizationContext *poc, CCostContext *pccParent,
	...
	CGroupExpression *PgexprBestPromise(CMemoryPool *pmpLocal, CMemoryPool *pmpGlobal,
...
public:
	...
	IStatistics *PstatsRecursiveDerive(CMemoryPool *pmpLocal, CMemoryPool *pmpGlobal,
	...
	void BuildTreeMap(CMemoryPool *mp, COptimizationContext *poc, CCostContext *pccParent,
					  ULONG child_index,
					  CTreeMap<CCostContext, CExpression, CDrvdPropCtxtPlan,
							   CCostContext::HashValue, CCostContext::Equals> *ptmap);
	...
	IStatistics *PstatsCompute(COptimizationContext *poc, CExpressionHandle &exprhdl,
