...
typedef CTreeMap<CCostContext, CExpression, CDrvdPropCtxtPlan, CCostContext::HashValue,
				 CCostContext::Equals>
	MemoTreeMap;
...
private:
	...
	CGroup *PgroupInsert(CGroup *pgroupTarget, CGroupExpression *pgexpr, CExpression *pexprOrigin,
						 BOOL fNewGroup);
...
public:
	...
	CExpression *PexprExtractPlan(CMemoryPool *mp, CGroup *pgroupRoot, CReqdPropPlan *prppInput,
