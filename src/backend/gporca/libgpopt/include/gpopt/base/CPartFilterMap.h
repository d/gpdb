...
private:
	...
	typedef CHashMap<ULONG, CPartFilter, gpos::HashValue<ULONG>, gpos::Equals<ULONG>, CleanupDelete<ULONG>,
					 CleanupRelease<CPartFilter> >
		UlongToPartFilterMap;

	// map iterator
	typedef CHashMapIter<ULONG, CPartFilter, gpos::HashValue<ULONG>, gpos::Equals<ULONG>, CleanupDelete<ULONG>,
						 CleanupRelease<CPartFilter> >
...
public:
	...
	void AddPartFilter(CMemoryPool *mp, ULONG scan_id, CExpression *pexpr, IStatistics *stats);
