...
private:
	...
	CExpression *PexprScalarCompEnd(CMemoryPool *mp, IDatum *datum, ERangeInclusion eri,
...
public:
	// ctor
	CRange(IMDId *mdid, const IComparator *pcomp, IDatum *pdatumLeft, ERangeInclusion eriLeft,
