...
public:
	// ctor
	CDistributionSpecHashed(CExpressionArray *pdrgpexpr, BOOL fNullsColocated, IMdIdArray *opfamilies = NULL);
	...
	virtual CDistributionSpec *PdsCopyWithRemappedColumns(CMemoryPool *mp, UlongToColRefMap *colref_mapping,
														  BOOL must_exist);
	...
	static CDistributionSpecHashed *CompleteEquivSpec(CMemoryPool *mp, CDistributionSpecHashed *pdshashed,
