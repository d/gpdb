...
public:
	...
	// ctor
	CDistributionSpecHashed(CExpressionArray *pdrgpexpr, BOOL fNullsColocated,
							CDistributionSpecHashed *pdshashedEquiv, IMdIdArray *opfamilies = NULL);

	static CDistributionSpecHashed *MakeHashedDistrSpec(CMemoryPool *mp,
	...
	static CDistributionSpecHashed *PdshashedMaximal(CMemoryPool *mp, CColRefArray *colref_array,
													 BOOL fNullsColocated);
	...
	static CDistributionSpecHashed *CompleteEquivSpec(CMemoryPool *mp,
