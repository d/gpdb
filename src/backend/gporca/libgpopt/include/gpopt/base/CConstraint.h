...
typedef CHashMap<CColRef, CConstraintArray, gpos::HashValue<CColRef>, gpos::Equals<CColRef>, CleanupNULL<CColRef>,
...
// of pointer values
typedef CHashMap<CConstraint, BOOL, gpos::HashPtr<CConstraint>, gpos::EqualPtr<CConstraint>, CleanupNULL<CConstraint>,
				 CleanupNULL<BOOL> >
	ConstraintContainmentMap;

// hash map mapping ULONG -> CConstraint
typedef CHashMap<ULONG, CConstraint, gpos::HashValue<ULONG>, gpos::Equals<ULONG>, CleanupDelete<ULONG>,
...
private:
	...
	static void AddColumnToEquivClasses(CMemoryPool *mp, const CColRef *colref, CColRefSetArray **ppdrgpcrs);
