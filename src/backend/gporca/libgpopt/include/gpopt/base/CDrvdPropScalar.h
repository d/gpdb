...
private:
	...
	// defined columns
	gpos::owner<CColRefSet *> m_pcrsDefined;

	// columns generated by set-returning-function like 'unnest'
	gpos::owner<CColRefSet *> m_pcrsSetReturningFunction;
...
public:
	...
	// defined columns
	gpos::pointer<CColRefSet *> GetDefinedColumns() const;

	// used columns
	gpos::pointer<CColRefSet *> GetUsedColumns() const;

	// columns containing set-returning function
	gpos::pointer<CColRefSet *> GetSetReturningFunctionColumns() const;
	...
	static gpos::cast_func<CDrvdPropScalar *> GetDrvdScalarProps(
		CDrvdProp *pdp);
