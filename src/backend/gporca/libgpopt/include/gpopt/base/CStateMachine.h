...
#define GRAPHVIZ_BOX(x) GRAPHVIZ_SHAPE("box", x)
	...
	typedef void (*PfWalker)(const CStateMachine *psm, TEnumState tenumstateOld,
							 TEnumState tenumstateNew, TEnumEvent tenumevent, void *pvContext);
	...
	static void
	Diagram(const CStateMachine *psm, TEnumState tenumstateSource, TEnumState tenumstateSink,
	...
	static void
	Unreachable(const CStateMachine *, TEnumState tenumstateSource, TEnumState tenumstateSink,
				TEnumEvent, void *pvContext)
	{
