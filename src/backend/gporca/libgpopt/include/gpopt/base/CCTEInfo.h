...
typedef CHashMap<CColRef, ULONG, gpos::HashValue<CColRef>, gpos::Equals<CColRef>, CleanupNULL<CColRef>,
				 CleanupDelete<ULONG> >
	ColRefToUlongMap;
...
private:
	...
	typedef CHashMap<ULONG, SConsumerCounter, gpos::HashValue<ULONG>, gpos::Equals<ULONG>, CleanupDelete<ULONG>,
					 CleanupDelete<SConsumerCounter> >
		UlongToConsumerCounterMap;

	// map iterator
	typedef CHashMapIter<ULONG, SConsumerCounter, gpos::HashValue<ULONG>, gpos::Equals<ULONG>, CleanupDelete<ULONG>,
						 CleanupDelete<SConsumerCounter> >
	...
	typedef CHashMap<ULONG, UlongToConsumerCounterMap, gpos::HashValue<ULONG>, gpos::Equals<ULONG>,
					 CleanupDelete<ULONG>, CleanupRelease<UlongToConsumerCounterMap> >
	...
	typedef CHashMap<ULONG, CCTEInfoEntry, gpos::HashValue<ULONG>, gpos::Equals<ULONG>, CleanupDelete<ULONG>,
					 CleanupRelease<CCTEInfoEntry> >
		UlongToCTEInfoEntryMap;

	// map iterator
	typedef CHashMapIter<ULONG, CCTEInfoEntry, gpos::HashValue<ULONG>, gpos::Equals<ULONG>, CleanupDelete<ULONG>,
						 CleanupRelease<CCTEInfoEntry> >
