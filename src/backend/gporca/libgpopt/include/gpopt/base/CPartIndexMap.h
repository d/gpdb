...
private:
	...
	typedef CHashMap<ULONG, CPartTableInfo, gpos::HashValue<ULONG>, gpos::Equals<ULONG>,
					 CleanupDelete<ULONG>, CleanupRelease<CPartTableInfo> >
	...
	static IOstream &OsPrintPartCnstrMap(ULONG part_idx_id, UlongToPartConstraintMap *ppartcnstrmap,
										 IOstream &os);
...
public:
	...
	static CPartIndexMap *PpimCombine(CMemoryPool *mp, const CPartIndexMap &pimFst,
