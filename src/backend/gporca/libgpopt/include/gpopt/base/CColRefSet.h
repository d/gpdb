...
typedef gpos::Vector<gpos::Ref<CColRefSet>> CColRefSetArray;

// hash map mapping CColRef -> CColRefSet
typedef gpos::UnorderedMap<const CColRef *, gpos::Ref<CColRefSet>,
...
public:
	...
	// convert to array
	gpos::Ref<CColRefArray> Pdrgpcr(CMemoryPool *mp) const;
