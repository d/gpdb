...
class CWindowFrame;
typedef gpos::Vector<gpos::Ref<CWindowFrame>> CWindowFrameArray;
...
public:
	...
	virtual gpos::Ref<CWindowFrame> PwfCopyWithRemappedColumns(
