...
public:
	...
	static IMDId *PmdidWindowReturnType(CMDAccessor *md_accessor,
										gpos::pointer<IMDId *> mdid);

	// does a cast object between given source and destination types exist
	static BOOL FCastExists(CMDAccessor *md_accessor,
	...
	static IMDId *GetScCmpMdid(CMDAccessor *md_accessor,
							   gpos::pointer<IMDId *> left_mdid,
							   gpos::pointer<IMDId *> right_mdid,
							   IMDType::ECmpType cmp_type);
	...
	static BOOL FCmpOrCastedCmpExists(gpos::pointer<IMDId *> left_mdid,
									  gpos::pointer<IMDId *> right_mdid,
									  IMDType::ECmpType cmp_type);
	...
	static IMDId *GetScCmpMdIdConsiderCasts(
	...
	static BOOL FCommutativeScalarOp(CMDAccessor *md_accessor,
	...
	static BOOL FBoolType(CMDAccessor *md_accessor,
