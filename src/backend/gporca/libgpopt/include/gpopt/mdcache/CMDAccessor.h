...
private:
	...
	typedef CSyncHashtableAccessByIter<SMDAccessorElem, MdidPtr> MDHTIterAccessor;

	// hashtable for MD providers indexed by the source system id
	typedef CSyncHashtable<SMDProviderElem, SMDProviderElem> MDPHT;

	typedef CSyncHashtableAccessByKey<SMDProviderElem, SMDProviderElem> MDPHTAccessor;

	// iterator for the providers hashtable
	typedef CSyncHashtableIter<SMDProviderElem, SMDProviderElem> MDPHTIter;
	typedef CSyncHashtableAccessByIter<SMDProviderElem, SMDProviderElem> MDPHTIterAccessor;
...
private:
	...
	void RecordColumnStats(CMemoryPool *mp, IMDId *rel_mdid, ULONG colid, ULONG ulPos,
...
public:
	...
	CMDAccessor(CMemoryPool *mp, MDCache *pcache, const CSystemIdArray *pdrgpsysid,
