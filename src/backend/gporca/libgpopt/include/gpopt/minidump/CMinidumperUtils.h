...
public:
	...
	static CDXLNode *PdxlnExecuteMinidump(CMemoryPool *mp, const CHAR *file_name, ULONG ulSegments,
										  ULONG ulSessionId, ULONG ulCmdId,
										  COptimizerConfig *optimizer_config,
										  IConstExprEvaluator *pceeval = NULL);

	// execute the given minidump
	static CDXLNode *PdxlnExecuteMinidump(CMemoryPool *mp, CDXLMinidump *pdxlmdp,
	...
	static CDXLNode *PdxlnExecuteMinidump(CMemoryPool *mp, CMDAccessor *md_accessor,
