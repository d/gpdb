...
public:
	...
	CDXLMinidump(CBitSet *pbs, COptimizerConfig *optimizer_config, CDXLNode *query,
				 CDXLNodeArray *query_output_dxlnode_array, CDXLNodeArray *cte_producers,
				 CDXLNode *pdxlnPlan, IMDCacheObjectArray *mdcache_obj_array,
				 CSystemIdArray *pdrgpsysid, ULLONG plan_id, ULLONG plan_space_size);
