...
const CMDAccessor::SMDProviderElem CMDAccessor::SMDProviderElem::m_mdpelemInvalid(CSystemId(IMDId::EmdidSentinel, NULL,
																							0),
																				  NULL);
...
//
//---------------------------------------------------------------------------
CMDAccessor::SMDAccessorElem::SMDAccessorElem(IMDCacheObject *pimdobj, IMDId *mdid) : m_imd_obj(pimdobj), m_mdid(mdid)
{
}
...
//---------------------------------------------------------------------------
BOOL
CMDAccessor::SMDProviderElem::Equals(const SMDProviderElem &mdpelemLeft, const SMDProviderElem &mdpelemRight)
{
...
//---------------------------------------------------------------------------
void
CMDAccessor::RecordColumnStats(CMemoryPool *mp, IMDId *rel_mdid, ULONG colid, ULONG ulPos, BOOL isSystemCol,
							   ...
							   UlongToDoubleMap *colid_width_mapping, CStatisticsConfig *stats_config)
{
	...
	BOOL fRecordMissingStats =
		!isEmptyTable && fGuc && !isSystemCol && (NULL != stats_config) && histogram->IsColStatsMissing();
...
//---------------------------------------------------------------------------
IStatistics *
CMDAccessor::Pstats(CMemoryPool *mp, IMDId *rel_mdid, CColRefSet *pcrsHist, CColRefSet *pcrsWidth,
...
//---------------------------------------------------------------------------
CHistogram *
CMDAccessor::GetHistogram(CMemoryPool *mp, IMDId *mdid_type, const IMDColStats *pmdcolstats)
{
	...
	CHistogram *histogram = GPOS_NEW(mp) CHistogram(mp, buckets, true /*is_well_defined*/, null_freq,
...
//---------------------------------------------------------------------------
CBucket *
CMDAccessor::Pbucket(CMemoryPool *mp, IMDId *mdid_type, const CDXLBucket *dxl_bucket)
{
...
//---------------------------------------------------------------------------
IDatum *
CMDAccessor::GetDatum(CMemoryPool *mp, IMDId *mdid_type, const CDXLDatum *dxl_datum)
{
