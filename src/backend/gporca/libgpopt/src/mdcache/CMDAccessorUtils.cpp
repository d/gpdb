...
BOOL
CMDAccessorUtils::FCmpExists(CMDAccessor *md_accessor, IMDId *left_mdid, IMDId *right_mdid,
										...
										IMDType::ECmpType cmp_type)
{
	...
	GPOS_TRY
	{
		(void) CMDAccessorUtils::GetScCmpMdIdConsiderCasts(md_accessor, left_mdid, right_mdid,
														   cmp_type);
...
// function.
IMDId *
CMDAccessorUtils::GetScCmpMdIdConsiderCasts(CMDAccessor *md_accessor, IMDId *left_mdid,
...
IMDId *
CMDAccessorUtils::GetScCmpMdIdConsiderCasts(CMDAccessor *md_accessor, CExpression *pexprLeft,
											CExpression *pexprRight, IMDType::ECmpType cmp_type)
{
	...
	return CMDAccessorUtils::GetScCmpMdIdConsiderCasts(md_accessor, left_mdid, right_mdid,
													   cmp_type);
}
