...
//
//---------------------------------------------------------------------------
CName::CName(CMemoryPool *mp, const CWStringBase *str) : m_str_name(NULL), m_fDeepCopy(true)
{
...
//
//---------------------------------------------------------------------------
CName::CName(CMemoryPool *mp, const CName &nameFirst, const CName &nameSecond) : m_str_name(NULL), m_fDeepCopy(false)
{
...
//
//---------------------------------------------------------------------------
CName::CName(CMemoryPool *mp, const CName &name) : m_str_name(NULL), m_fDeepCopy(false)
{
