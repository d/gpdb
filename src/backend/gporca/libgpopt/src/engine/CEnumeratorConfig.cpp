...
//
//---------------------------------------------------------------------------
CEnumeratorConfig::CEnumeratorConfig(CMemoryPool *mp, ULLONG plan_id, ULLONG ullSamples,
...
CEnumeratorConfig::FitCostDistribution()
{
	...
	GussianKernelDensity(pdObervationX, pdObervationY, ulCreatedSamples, m_pdX, m_pdY,
						 m_ulDistrSize);
							   ...
							   ULONG ulSessionId, ULONG ulCommandId)
{
	...
	CUtils::GenerateFileName(file_name, "SamplePlans", "xml", GPOS_FILE_NAME_BUF_SIZE, ulSessionId,
							 ulCommandId);
	CHAR *sz =
								 ...
								 ULONG ulSessionId, ULONG ulCommandId)
{
	...
	CHAR file_name[GPOS_FILE_NAME_BUF_SIZE];
	CUtils::GenerateFileName(file_name, "CostDistr", "xml", GPOS_FILE_NAME_BUF_SIZE, ulSessionId,
							 ulCommandId);
	CHAR *sz =
		CUtils::CreateMultiByteCharStringFromWCString(m_mp, const_cast<WCHAR *>(str->GetBuffer()));
	CIOUtils::Dump(file_name, sz);
