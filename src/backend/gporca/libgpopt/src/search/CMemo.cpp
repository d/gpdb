...
CMemo::~CMemo()
{
	gpos::Ref<CGroup> pgroup = m_listGroups.PtFirst();
...
//---------------------------------------------------------------------------
BOOL
CMemo::FNewGroup(gpos::Ref<CGroup> *ppgroupTarget, CGroupExpression *pgexpr,
				 BOOL fScalar)
{
...
//---------------------------------------------------------------------------
CGroup *
CMemo::PgroupInsert(gpos::Ref<CGroup> pgroupTarget, CExpression *pexprOrigin,
