...
//
//---------------------------------------------------------------------------
CCTEReq::CCTEReqEntry::CCTEReqEntry(ULONG id, CCTEMap::ECteType ect, BOOL fRequired,
...
//
//---------------------------------------------------------------------------
CCTEReq::CCTEReq(CMemoryPool *mp) : m_mp(mp), m_phmcter(NULL), m_pdrgpulRequired(NULL)
{
	GPOS_ASSERT(NULL != mp);
