...
//---------------------------------------------------------------------------
void
CPartFilterMap::AddPartFilter(CMemoryPool *mp, ULONG scan_id, CExpression *pexpr,
							  IStatistics *stats)
{
	GPOS_ASSERT(NULL != pexpr);
	CPartFilter *ppf = m_phmulpf->Find(&scan_id);
...
//---------------------------------------------------------------------------
BOOL
CPartFilterMap::FCopyPartFilter(CMemoryPool *mp, ULONG scan_id, CPartFilterMap *ppfmSource,
