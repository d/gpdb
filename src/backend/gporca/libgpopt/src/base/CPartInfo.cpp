...
CPartInfo::CPartInfoEntry::PpartinfoentryAddRemappedKeys(CMemoryPool *mp, CColRefSet *pcrs,
														 UlongToColRefMap *colref_mapping)
{
	...
	m_mdid->AddRef();
	CPartConstraint *ppartcnstrRel =
		m_ppartcnstrRel->PpartcnstrCopyWithRemappedColumns(mp, colref_mapping, false /*must_exist*/);
...
CPartInfo::CPartInfoEntry::PpartinfoentryCopy(CMemoryPool *mp)
{
	...
	CPartConstraint *ppartcnstrRel =
		PpartcnstrRel()->PpartcnstrCopyWithRemappedColumns(mp, colref_mapping, false /*must_exist*/);
...
//---------------------------------------------------------------------------
void
CPartInfo::AddPartConsumer(CMemoryPool *mp, ULONG scan_id, IMDId *mdid, CColRef2dArray *pdrgpdrgpcrPart,
						   CPartConstraint *ppartcnstrRel)
{
...
//---------------------------------------------------------------------------
CPartInfo *
CPartInfo::PpartinfoCombine(CMemoryPool *mp, CPartInfo *ppartinfoFst, CPartInfo *ppartinfoSnd)
{
