...
{
	if (NULL == m_pdatumLeft || NULL == m_pdatumRight || !m_pcomp->Equals(m_pdatumLeft, m_pdatumRight) ||
...
//---------------------------------------------------------------------------
CExpression *
CRange::PexprScalarCompEnd(CMemoryPool *mp, IDatum *datum, ERangeInclusion eri, IMDType::ECmpType ecmptIncl,
