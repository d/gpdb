...
CXformInnerApplyWithOuterKey2InnerJoin::Exfp(CExpressionHandle &exprhdl) const
{
	...
	if (NULL == exprhdl.DeriveKeyCollection(0) || 0 == exprhdl.DeriveOuterReferences(1)->Size())
	{
		return ExfpNone;
	}
...
//---------------------------------------------------------------------------
void
CXformInnerApplyWithOuterKey2InnerJoin::Transform(CXformContext *pxfctxt, CXformResult *pxfres,
