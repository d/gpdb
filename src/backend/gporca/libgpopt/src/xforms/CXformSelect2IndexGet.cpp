...
//---------------------------------------------------------------------------
void
CXformSelect2IndexGet::Transform(CXformContext *pxfctxt, CXformResult *pxfres, CExpression *pexpr) const
{
	...
	for (ULONG ul = 0; ul < ulIndices; ul++)
	{
		...
		CExpression *pexprIndexGet = CXformUtils::PexprLogicalIndexGet(
			...
			NULL /*outer_refs*/, pmdindex, pmdrel, false /*fAllowPartialIndex*/, NULL /*ppartcnstrIndex*/
		);
