...
//---------------------------------------------------------------------------
BOOL
CXformSimplifySubquery::FSimplifyQuantified(CMemoryPool *mp, CExpression *pexprScalar,
...
//---------------------------------------------------------------------------
BOOL
CXformSimplifySubquery::FSimplifyExistential(CMemoryPool *mp, CExpression *pexprScalar,
											 CExpression **ppexprNewScalar)
{
								  ...
								  CExpression *pexpr) const
{
	...
	for (ULONG ul = 0; ul < size; ul++)
	{
		...
		if (!FSimplify(mp, pexprScalar, &pexprNewScalar, m_rgssm[ul].m_pfnsimplify,
		...
		else
		{
			...
			pexprResult = CUtils::PexprLogicalProject(mp, pexprOuter, pexprNewScalar,
