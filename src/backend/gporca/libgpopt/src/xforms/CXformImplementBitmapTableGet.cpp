...
//---------------------------------------------------------------------------
void
CXformImplementBitmapTableGet::Transform(CXformContext *pxfctxt, CXformResult *pxfres,
										 CExpression *pexpr) const
{
	...
	CPhysicalBitmapTableScan *popPhysical = GPOS_NEW(mp) CPhysicalBitmapTableScan(
		mp, ptabdesc, pexpr->Pop()->UlOpId(),
		GPOS_NEW(mp) CName(mp, *popLogical->PnameTableAlias()), pdrgpcrOutput);
