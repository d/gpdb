														 ...
														 CExpression *pexpr) const
{
	...
	CExpression *pexprInnerJoin = GPOS_NEW(mp)
		CExpression(mp, GPOS_NEW(mp) CLogicalInnerJoin(mp), pexprInner,
	...
	CExpression *pexprProjectAppendNulls =
		PexprProjectOverLeftAntiSemiJoin(mp, pdrgpcrOuter, pcrsScalar, pcrsInner, pdrgpcrJoinOutput,
	...
	CExpression *pexprUnionAll = GPOS_NEW(mp) CExpression(
		mp, GPOS_NEW(mp) CLogicalUnionAll(mp, pdrgpcrJoinOutput, pdrgpdrgpcrUnionInput),
...
CExpression *
CXformLeftOuter2InnerUnionAllLeftAntiSemiJoin::PexprLeftAntiSemiJoinWithInnerGroupBy(
	CMemoryPool *mp, CColRefArray *pdrgpcrOuter, CColRefArray *pdrgpcrOuterCopy,
	CColRefSet *pcrsScalar, CColRefSet *pcrsInner, CColRefArray *pdrgpcrJoinOutput,
	ULONG ulCTEJoinId, ULONG ulCTEOuterId)
{
	...
	CExpression *pexprGby = GPOS_NEW(mp)
		CExpression(mp, GPOS_NEW(mp) CLogicalGbAgg(mp, pdrgpcrGbyKeys, COperator::EgbaggtypeGlobal),
...
CXformLeftOuter2InnerUnionAllLeftAntiSemiJoin::PexprProjectOverLeftAntiSemiJoin(
	...
	CColRefArray *pdrgpcrJoinOutput, ULONG ulCTEJoinId, ULONG ulCTEOuterId,
	CColRefArray **ppdrgpcrProjectOutput)
{
	...
	CExpression *pexprLeftAntiSemi = PexprLeftAntiSemiJoinWithInnerGroupBy(
		mp, pdrgpcrOuter, pdrgpcrOuterCopy, pcrsScalar, pcrsInner, pdrgpcrJoinOutput, ulCTEJoinId,
		ulCTEOuterId);
