...
//---------------------------------------------------------------------------
void
CXformSplitGbAgg::PopulateLocalGlobalProjectList(CMemoryPool *mp, CExpression *pexprProjList,
												 CExpression **ppexprProjListLocal, CExpression **ppexprProjListGlobal)
{
	...
	for (ULONG ul = 0; ul < arity; ul++)
	{
		...
		CExpression *pexprAggFuncGlobal = GPOS_NEW(mp) CExpression(mp, popScAggFuncGlobal, pdrgpexprGlobal);
