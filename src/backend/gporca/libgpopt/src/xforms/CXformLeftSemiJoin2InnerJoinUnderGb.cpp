...
CXformLeftSemiJoin2InnerJoinUnderGb::Exfp(CExpressionHandle &exprhdl) const
{
	...
	CAutoMemoryPool amp;
	if (exprhdl.HasOuterRefs() || NULL == exprhdl.DeriveKeyCollection(0) || NULL == pexprScalar ||
...
//---------------------------------------------------------------------------
void
CXformLeftSemiJoin2InnerJoinUnderGb::Transform(CXformContext *pxfctxt, CXformResult *pxfres, CExpression *pexpr) const
{
