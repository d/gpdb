...
//
//---------------------------------------------------------------------------
CSerializablePlan::CSerializablePlan(CMemoryPool *mp, const CDXLNode *pdxlnPlan, ULLONG plan_id,
...
{
	CDXLUtils::SerializePlan(m_mp, oos, m_plan_dxl_root, m_plan_id, m_plan_space_size,
							 false /*fSerializeHeaders*/, false /*indentation*/
	);
}
