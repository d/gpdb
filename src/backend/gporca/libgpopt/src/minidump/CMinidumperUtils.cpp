...
CMinidumperUtils::PdxlmdLoad(CMemoryPool *mp, const CHAR *file_name)
{
	...
	return GPOS_NEW(mp)
		CDXLMinidump(pbs, optimizer_config, query, query_output_dxlnode_array, cte_producers,
...
//---------------------------------------------------------------------------
CDXLNode *
CMinidumperUtils::PdxlnExecuteMinidump(CMemoryPool *mp, const CHAR *file_name, ULONG ulSegments,
									   ...
									   IConstExprEvaluator *pceeval)
{
	...
	CDXLNode *pdxlnPlan = PdxlnExecuteMinidump(mp, pdxlmd, file_name, ulSegments, ulSessionId,
...
//---------------------------------------------------------------------------
CDXLNode *
CMinidumperUtils::PdxlnExecuteMinidump(CMemoryPool *mp, CDXLMinidump *pdxlmd, const CHAR *file_name,
									   ...
									   IConstExprEvaluator *pceeval)
{
	...
	CDXLNode *result =
		CMinidumperUtils::PdxlnExecuteMinidump(mp, factory.Pmda(), pdxlmd, file_name, ulSegments,
...
//---------------------------------------------------------------------------
CDXLNode *
CMinidumperUtils::PdxlnExecuteMinidump(CMemoryPool *mp, CMDAccessor *md_accessor,
									   CDXLMinidump *pdxlmd, const CHAR *file_name,
									   ULONG ulSegments, ULONG ulSessionId, ULONG ulCmdId,
									   COptimizerConfig *optimizer_config,
									   IConstExprEvaluator *pceeval)
{
	...
	GPOS_TRY_HDL(&errhdl)
	{
		pdxlnPlan = COptimizer::PdxlnOptimize(
			mp, md_accessor, pdxlmd->GetQueryDXLRoot(), pdxlmd->PdrgpdxlnQueryOutput(),
