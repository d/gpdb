...
//
//---------------------------------------------------------------------------
CPhysicalExternalScan::CPhysicalExternalScan(CMemoryPool *mp, const CName *pnameAlias, CTableDescriptor *ptabdesc,
...
CPhysicalExternalScan::Matches(COperator *pop) const
{
	...
	return m_ptabdesc == popExternalScan->Ptabdesc() && m_pdrgpcrOutput->Equals(popExternalScan->PdrgpcrOutput());
}
...
CPhysicalExternalScan::EpetRewindability(CExpressionHandle &exprhdl, const CEnfdRewindability *per) const
{
