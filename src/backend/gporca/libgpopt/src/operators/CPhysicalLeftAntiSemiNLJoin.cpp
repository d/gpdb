...
//---------------------------------------------------------------------------
BOOL
CPhysicalLeftAntiSemiNLJoin::FProvidesReqdCols(CExpressionHandle &exprhdl, CColRefSet *pcrsRequired,
											   ULONG  // ulOptReq
) const
{
...
CPhysicalLeftAntiSemiNLJoin::PppsRequired(CMemoryPool *mp, CExpressionHandle &exprhdl,
