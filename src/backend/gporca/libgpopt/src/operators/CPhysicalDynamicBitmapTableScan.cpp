...
//---------------------------------------------------------------------------
CPhysicalDynamicBitmapTableScan::CPhysicalDynamicBitmapTableScan(
	CMemoryPool *mp, BOOL is_partial, CTableDescriptor *ptabdesc, ULONG ulOriginOpId,
...
//---------------------------------------------------------------------------
IStatistics *
CPhysicalDynamicBitmapTableScan::PstatsDerive(CMemoryPool *mp, CExpressionHandle &exprhdl,
											  ...
											  IStatisticsArray *stats_ctxt) const
{
	...
	CPredicateUtils::SeparateOuterRefs(mp, pexprCondChild, outer_refs, &local_expr,
