...
CLogicalIndexApply::CLogicalIndexApply(CMemoryPool *mp, CColRefArray *pdrgpcrOuterRefs,
									   BOOL fOuterJoin)
...
) const
{
	...
	IStatistics *stats = CJoinStatsProcessor::CalcAllJoinStats(
		mp, statistics_array, pexprScalar, const_cast<CLogicalIndexApply *>(this));
...
COperator *
CLogicalIndexApply::PopCopyWithRemappedColumns(CMemoryPool *mp, UlongToColRefMap *colref_mapping,
											   BOOL must_exist)
{
