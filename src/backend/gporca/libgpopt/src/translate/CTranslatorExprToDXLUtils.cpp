...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnPartialScanTest(CMemoryPool *mp, CMDAccessor *md_accessor,
	...
	for (ULONG ul = 0; ul < ulLevels; ul++)
	{
		...
		if (!fScalarFalse)
		{
			...
			CDXLNode *pdxlnNotDefault =
				GPOS_NEW(mp) CDXLNode(mp, GPOS_NEW(mp) CDXLScalarBoolExpr(mp, Edxlnot),
												...
												BOOL fRangePart)
{
	...
	switch (pcnstr->Ect())
	{
		case CConstraint::EctConjunction:
			return PdxlnPartialScanTestConjunction(mp, md_accessor, col_factory, pcnstr,
												   pdrgpdrgpcrPartKeys, fRangePart);

		case CConstraint::EctDisjunction:
			return PdxlnPartialScanTestDisjunction(mp, md_accessor, col_factory, pcnstr,
												   pdrgpdrgpcrPartKeys, fRangePart);

		case CConstraint::EctNegation:
			return PdxlnPartialScanTestNegation(mp, md_accessor, col_factory, pcnstr,
												pdrgpdrgpcrPartKeys, fRangePart);

		case CConstraint::EctInterval:
			return PdxlnPartialScanTestInterval(mp, md_accessor, pcnstr, pdrgpdrgpcrPartKeys,
												fRangePart);
														...
														BOOL fRangePart)
{
	...
	if (1 == length)
	{
		return PdxlnPartialScanTest(mp, md_accessor, col_factory, (*pdrgpcnstr)[0],
									pdrgpdrgpcrPartKeys, fRangePart);
	}
	...
	for (ULONG ul = 0; ul < length; ul++)
	{
		...
		CDXLNode *dxlnode = PdxlnPartialScanTest(mp, md_accessor, col_factory, pcnstr,
												 pdrgpdrgpcrPartKeys, fRangePart);
...
CTranslatorExprToDXLUtils::PdxlnPropagationExpressionForPartConstraints(
	...
	UlongToPartConstraintMap *ppartcnstrmap, CColRef2dArray *pdrgpdrgpcrPartKeys,
	CharPtrArray *pdrgszPartTypes)
{
	...
	while (pcmi.Advance())
	{
		...
		CDXLNode *pdxlnTest = PdxlnPartialScanTest(mp, md_accessor, col_factory, ppartcnstr,
...
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnPartialScanTestConjunction(
	CMemoryPool *mp, CMDAccessor *md_accessor, CColumnFactory *col_factory, CConstraint *pcnstr,
	CColRef2dArray *pdrgpdrgpcrPartKeys, BOOL fRangePart)
{
	...
	return PdxlnPartialScanTestConjDisj(mp, md_accessor, col_factory, pdrgpcnstr,
										true /*fConjunction*/, pdrgpdrgpcrPartKeys, fRangePart);
}
	...
	CColRef2dArray *pdrgpdrgpcrPartKeys, BOOL fRangePart)
{
	...
	return PdxlnPartialScanTestConjDisj(mp, md_accessor, col_factory, pdrgpcnstr,
										false /*fConjunction*/, pdrgpdrgpcrPartKeys, fRangePart);
}
														...
														BOOL fRangePart)
{
	...
	CDXLNode *child_dxlnode = PdxlnPartialScanTest(mp, md_accessor, col_factory, pcnstrChild,
												   pdrgpdrgpcrPartKeys, fRangePart);
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnPartialScanTestInterval(CMemoryPool *mp, CMDAccessor *md_accessor,
														CConstraint *pcnstr,
														CColRef2dArray *pdrgpdrgpcrPartKeys,
														BOOL fRangePart)
{
	...
	if (1 == ulRanges)
	{
		return PdxlnPartialScanTestRange(mp, md_accessor, (*pdrgprng)[0], pmdidPartKeyType,
	...
	for (ULONG ul = 0; ul < ulRanges; ul++)
	{
		...
		CDXLNode *child_dxlnode = PdxlnPartialScanTestRange(mp, md_accessor, prng, pmdidPartKeyType,
															ulPartLevel, fRangePart);
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnPartialScanTestRange(CMemoryPool *mp, CMDAccessor *md_accessor,
													 CRange *prng, IMDId *pmdidPartKeyType,
													 ULONG ulPartLevel, BOOL fRangePart)
{
	...
	else  // list partition
	{
		...
		CDXLNode *pdxlnPartList =
			GPOS_NEW(mp) CDXLNode(mp, GPOS_NEW(mp) CDXLScalarPartListValues(
		...
		CDXLNode *pdxlnScCmp = GPOS_NEW(mp)
			CDXLNode(mp,
					 GPOS_NEW(mp) CDXLScalarArrayComp(
						 mp, pmdidEq, GPOS_NEW(mp) CWStringConst(mp, pmdidEq->GetBuffer()),
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnRangeStartPredicate(CMemoryPool *mp, CMDAccessor *md_accessor,
													IDatum *datum, CRange::ERangeInclusion eri,
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnRangeEndPredicate(CMemoryPool *mp, CMDAccessor *md_accessor,
												  IDatum *datum, CRange::ERangeInclusion eri,
												  IMDId *pmdidPartKeyType, ULONG ulPartLevel)
{
	const IMDType *pmdtype = md_accessor->RetrieveType(pmdidPartKeyType);
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnRangePointPredicate(CMemoryPool *mp, CMDAccessor *md_accessor,
													IDatum *datum, CRange::ERangeInclusion eri,
													IMDId *pmdidPartKeyType, IMDId *pmdidCmpExl,
													...
													BOOL is_lower_bound)
{
	...
	return GPOS_NEW(mp) CDXLNode(mp, GPOS_NEW(mp) CDXLScalarBoolExpr(mp, Edxlor),
...
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnListFilterPartKey(CMemoryPool *mp, CMDAccessor *md_accessor,
												  ...
												  IMDId *pmdidTypePartKey, ULONG ulPartLevel)
{
	...
	else
	{
		...
		GPOS_THROW_EXCEPTION(gpopt::ExmaGPOPT, gpopt::ExmiUnsupportedOp, CException::ExsevDebug1,
							 str->GetBuffer());
	}
...
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnListFilterScCmp(CMemoryPool *mp, CMDAccessor *md_accessor,
												CDXLNode *pdxlnPartKey, CDXLNode *pdxlnOther,
												...
												BOOL fHasDefaultPart)
{
	...
	pmdidScCmp = CMDAccessorUtils::GetScCmpMdIdConsiderCasts(md_accessor, pmdidTypeOther,
															 pmdidTypePartKey, cmp_type);
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnRangeFilterScCmp(CMemoryPool *mp, CMDAccessor *md_accessor,
												 CDXLNode *pdxlnScalar, IMDId *pmdidTypePartKey,
												 IMDId *pmdidTypeOther, IMDId *pmdidTypeCastExpr,
												 IMDId *mdid_cast_func, IMDType::ECmpType cmp_type,
												 ULONG ulPartLevel)
{
	if (IMDType::EcmptEq == cmp_type)
	{
		return PdxlnRangeFilterEqCmp(mp, md_accessor, pdxlnScalar, pmdidTypePartKey, pmdidTypeOther,
	...
	if (IMDType::EcmptLEq != cmp_type && IMDType::EcmptGEq != cmp_type)
	{
		...
		CDXLNode *pdxlnPredicateExclusive =
			PdxlnCmp(mp, md_accessor, ulPartLevel, fLowerBound, pdxlnScalar, ecmptScCmp,
	...
	CDXLNode *pdxlnInclusiveCmp =
		PdxlnCmp(mp, md_accessor, ulPartLevel, fLowerBound, pdxlnScalar, cmp_type, pmdidTypePartKey,
				 pmdidTypeOther, pmdidTypeCastExpr, mdid_cast_func);

	if (NULL != mdid_cast_func &&
		md_accessor->RetrieveFunc(mdid_cast_func)->IsAllowedForPS())  // is a lossy cast
	{
	...
	CDXLNode *pdxlnPredicateInclusive =
		GPOS_NEW(mp) CDXLNode(mp, GPOS_NEW(mp) CDXLScalarBoolExpr(mp, Edxland), pdxlnInclusiveCmp,
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnRangeFilterEqCmp(CMemoryPool *mp, CMDAccessor *md_accessor,
												 CDXLNode *pdxlnScalar, IMDId *pmdidTypePartKey,
												 IMDId *pmdidTypeOther, IMDId *pmdidTypeCastExpr,
												 IMDId *mdid_cast_func, ULONG ulPartLevel)
{
	CDXLNode *pdxlnPredicateMin = PdxlnRangeFilterPartBound(
		mp, md_accessor, pdxlnScalar, pmdidTypePartKey, pmdidTypeOther, pmdidTypeCastExpr,
	...
	return GPOS_NEW(mp) CDXLNode(mp, GPOS_NEW(mp) CDXLScalarBoolExpr(mp, Edxland),
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnRangeFilterPartBound(CMemoryPool *mp, CMDAccessor *md_accessor,
													 CDXLNode *pdxlnScalar, IMDId *pmdidTypePartKey,
													 ...
													 ULONG fLowerBound, IMDType::ECmpType cmp_type)
{
	...
	CDXLNode *pdxlnInclusiveCmp =
		PdxlnCmp(mp, md_accessor, ulPartLevel, fLowerBound, pdxlnScalar, ecmptInc, pmdidTypePartKey,
				 pmdidTypeOther, pmdidTypeCastExpr, mdid_cast_func);
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnRangeFilterDefaultAndOpenEnded(CMemoryPool *mp, ULONG ulPartLevel,
															   BOOL fLTComparison,
															   BOOL fGTComparison,
															   BOOL fEQComparison,
															   BOOL fDefaultPart)
{
	...
	if (fGTComparison || fEQComparison)
	{
		...
		if (NULL != pdxlnResult)
		{
			pdxlnResult = GPOS_NEW(mp) CDXLNode(mp, GPOS_NEW(mp) CDXLScalarBoolExpr(mp, Edxlor),
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnCmp(CMemoryPool *mp, CMDAccessor *md_accessor, ULONG ulPartLevel,
									BOOL fLowerBound, CDXLNode *pdxlnScalar,
									IMDType::ECmpType cmp_type, IMDId *pmdidTypePartKey,
									IMDId *pmdidTypeExpr, IMDId *pmdidTypeCastExpr,
									IMDId *mdid_cast_func)
{
	...
	{
		pmdidScCmp = CMDAccessorUtils::GetScCmpMdIdConsiderCasts(md_accessor, pmdidTypeCastExpr,
																 pmdidTypeExpr, cmp_type);
	}
	else
	{
		pmdidScCmp = CMDAccessorUtils::GetScCmpMdIdConsiderCasts(md_accessor, pmdidTypePartKey,
																 pmdidTypeExpr, cmp_type);
	}
...
CTranslatorExprToDXLUtils::PcrCreate(CMemoryPool *mp, CMDAccessor *md_accessor,
									 CColumnFactory *col_factory, IMDId *mdid_type,
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnProjListFromChildProjList(CMemoryPool *mp,
														  CColumnFactory *col_factory,
...
CTranslatorExprToDXLUtils::PdxlnPrLPartitionSelector(CMemoryPool *mp, CMDAccessor *md_accessor,
													 ...
													 CDXLNode *pdxlnPrLChild, CColRef *pcrOid,
...
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnPropExprPartitionSelector(
	CMemoryPool *mp, CMDAccessor *md_accessor, CColumnFactory *col_factory, BOOL fConditional,
	UlongToPartConstraintMap *ppartcnstrmap, CColRef2dArray *pdrgpdrgpcrKeys, ULONG scan_id,
	CharPtrArray *pdrgszPartTypes)
{
	if (!fConditional)
	{
	...
	return PdxlnPropagationExpressionForPartConstraints(mp, md_accessor, col_factory, ppartcnstrmap,
														pdrgpdrgpcrKeys, pdrgszPartTypes);
}
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnProjElem(CMemoryPool *mp, CColumnFactory *col_factory,
										 ColRefToDXLNodeMap *phmcrdxln,
...
//---------------------------------------------------------------------------
CColRefArray *
CTranslatorExprToDXLUtils::PdrgpcrMapColumns(CMemoryPool *mp, CColRefArray *pdrgpcrInput,
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnResult(CMemoryPool *mp, CDXLPhysicalProperties *dxl_properties,
...
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnValuesScan(CMemoryPool *mp, CDXLPhysicalProperties *dxl_properties,
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnPartitionSelector(CMemoryPool *mp, IMDId *mdid, ULONG ulPartLevels,
												  ULONG scan_id,
												  CDXLPhysicalProperties *dxl_properties,
											   ...
											   EdxlBoolExprType boolexptype)
{
	...
	return GPOS_NEW(mp) CDXLNode(mp, GPOS_NEW(mp) CDXLScalarBoolExpr(mp, boolexptype),
...
//---------------------------------------------------------------------------
void
CTranslatorExprToDXLUtils::SetDirectDispatchInfo(CMemoryPool *mp, CMDAccessor *md_accessor,
												 CDXLNode *dxlnode, CExpression *pexpr,
...
//---------------------------------------------------------------------------
CDXLDirectDispatchInfo *
CTranslatorExprToDXLUtils::PdxlddinfoSingleDistrKey(CMemoryPool *mp, CMDAccessor *md_accessor,
...
//---------------------------------------------------------------------------
CDXLDatum2dArray *
CTranslatorExprToDXLUtils::PdrgpdrgpdxldatumFromDisjPointConstraint(CMemoryPool *mp,
...
//---------------------------------------------------------------------------
void
CTranslatorExprToDXLUtils::ExtractCastFuncMdids(COperator *pop, IMDId **ppmdidType,
...
BOOL
CTranslatorExprToDXLUtils::FDXLOpExists(const CDXLOperator *pop, const gpdxl::Edxlopid *peopid,
										ULONG ulOps)
{
	GPOS_ASSERT(NULL != pop);
...
BOOL
CTranslatorExprToDXLUtils::FHasDXLOp(const CDXLNode *dxlnode, const gpdxl::Edxlopid *peopid,
									 ULONG ulOps)
{
