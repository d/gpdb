...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnInt4Const(CMemoryPool *mp, CMDAccessor *md_accessor, INT val)
{
	GPOS_ASSERT(NULL != mp);
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnBoolConst(CMemoryPool *mp, CMDAccessor *md_accessor, BOOL value)
{
	GPOS_ASSERT(NULL != mp);
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnPartialScanTest(CMemoryPool *mp, CMDAccessor *md_accessor, CColumnFactory *col_factory,
	...
	for (ULONG ul = 0; ul < ulLevels; ul++)
	{
		...
		if (!fScalarFalse)
		{
			...
			CDXLNode *pdxlnNotDefault = GPOS_NEW(mp)
				CDXLNode(mp, GPOS_NEW(mp) CDXLScalarBoolExpr(mp, Edxlnot), PdxlnDefaultPartitionTest(mp, ul));

			pdxlnPartialScanTest = GPOS_NEW(mp)
				CDXLNode(mp, GPOS_NEW(mp) CDXLScalarBoolExpr(mp, Edxland), pdxlnNotDefault, pdxlnPartialScanTest);
		}
		...
		if (ppartcnstr->IsDefaultPartition(ul))
		{
			...
			{
				pdxlnPartialScanTest = GPOS_NEW(mp) CDXLNode(mp, GPOS_NEW(mp) CDXLScalarBoolExpr(mp, Edxlor),
															 pdxlnPartialScanTest, pdxlnDefaultPartitionTest);
			}
		}
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnDefaultPartitionTest(CMemoryPool *mp, ULONG ulPartLevel)
{
	CDXLNode *pdxlnDefaultPart = GPOS_NEW(mp) CDXLNode(mp, GPOS_NEW(mp) CDXLScalarPartDefault(mp, ulPartLevel));
												...
												BOOL fRangePart)
{
	...
	switch (pcnstr->Ect())
	{
		case CConstraint::EctConjunction:
			return PdxlnPartialScanTestConjunction(mp, md_accessor, col_factory, pcnstr, pdrgpdrgpcrPartKeys,
												   fRangePart);

		case CConstraint::EctDisjunction:
			return PdxlnPartialScanTestDisjunction(mp, md_accessor, col_factory, pcnstr, pdrgpdrgpcrPartKeys,
												   fRangePart);
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnPartialScanTestConjDisj(CMemoryPool *mp, CMDAccessor *md_accessor,
														CColumnFactory *col_factory, CConstraintArray *pdrgpcnstr,
														BOOL fConjunction, CColRef2dArray *pdrgpdrgpcrPartKeys,
														BOOL fRangePart)
{
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnPropagationExpressionForPartConstraints(CMemoryPool *mp, CMDAccessor *md_accessor,
																		...
																		CharPtrArray *pdrgszPartTypes)
{
	...
	while (pcmi.Advance())
	{
		...
		CDXLNode *pdxlnTest =
			PdxlnPartialScanTest(mp, md_accessor, col_factory, ppartcnstr, pdrgpdrgpcrPartKeys, pdrgszPartTypes);

		CDXLNode *pdxlnPropagate = PdxlnInt4Const(mp, md_accessor, (INT) ulSecondaryScanId);

		mdid_return_type->AddRef();
		CDXLNode *pdxlnScalarIf =
			GPOS_NEW(mp) CDXLNode(mp, GPOS_NEW(mp) CDXLScalarIfStmt(mp, mdid_return_type), pdxlnTest, pdxlnPropagate);
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnPartialScanTestConjunction(CMemoryPool *mp, CMDAccessor *md_accessor,
														   CColumnFactory *col_factory, CConstraint *pcnstr,
														   CColRef2dArray *pdrgpdrgpcrPartKeys, BOOL fRangePart)
{
	...
	return PdxlnPartialScanTestConjDisj(mp, md_accessor, col_factory, pdrgpcnstr, true /*fConjunction*/,
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnPartialScanTestDisjunction(CMemoryPool *mp, CMDAccessor *md_accessor,
														   CColumnFactory *col_factory, CConstraint *pcnstr,
														   CColRef2dArray *pdrgpdrgpcrPartKeys, BOOL fRangePart)
{
	...
	return PdxlnPartialScanTestConjDisj(mp, md_accessor, col_factory, pdrgpcnstr, false /*fConjunction*/,
										pdrgpdrgpcrPartKeys, fRangePart);
}
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnPartialScanTestNegation(CMemoryPool *mp, CMDAccessor *md_accessor,
														CColumnFactory *col_factory, CConstraint *pcnstr,
														CColRef2dArray *pdrgpdrgpcrPartKeys, BOOL fRangePart)
{
	...
	CDXLNode *child_dxlnode =
		PdxlnPartialScanTest(mp, md_accessor, col_factory, pcnstrChild, pdrgpdrgpcrPartKeys, fRangePart);
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnPartialScanTestInterval(CMemoryPool *mp, CMDAccessor *md_accessor, CConstraint *pcnstr,
														CColRef2dArray *pdrgpdrgpcrPartKeys, BOOL fRangePart)
{
	...
	for (ULONG ul = 0; ul < ulRanges; ul++)
	{
		...
		CDXLNode *child_dxlnode =
			PdxlnPartialScanTestRange(mp, md_accessor, prng, pmdidPartKeyType, ulPartLevel, fRangePart);
...
//---------------------------------------------------------------------------
ULONG
CTranslatorExprToDXLUtils::UlPartKeyLevel(const CColRef *colref, CColRef2dArray *pdrgpdrgpcr)
{
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnPartialScanTestRange(CMemoryPool *mp, CMDAccessor *md_accessor, CRange *prng,
													 IMDId *pmdidPartKeyType, ULONG ulPartLevel, BOOL fRangePart)
{
	if (fRangePart)
	{
		CDXLNode *pdxlnStart = PdxlnRangeStartPredicate(mp, md_accessor, prng->PdatumLeft(), prng->EriLeft(),
														pmdidPartKeyType, ulPartLevel);
		CDXLNode *pdxlnEnd = PdxlnRangeEndPredicate(mp, md_accessor, prng->PdatumRight(), prng->EriRight(),
													pmdidPartKeyType, ulPartLevel);
	...
	else  // list partition
	{
		...
		CDXLNode *pdxlnPartList = GPOS_NEW(mp)
			CDXLNode(mp, GPOS_NEW(mp) CDXLScalarPartListValues(mp, ulPartLevel, result_type_mdid, pmdidPartKeyType));

		IMDId *pmdidEq = pmdtype->GetMdidForCmpType(IMDType::EcmptEq);
		pmdidEq->AddRef();
		CDXLNode *pdxlnScCmp = GPOS_NEW(mp)
			CDXLNode(mp,
					 GPOS_NEW(mp) CDXLScalarArrayComp(mp, pmdidEq, GPOS_NEW(mp) CWStringConst(mp, pmdidEq->GetBuffer()),
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnRangeStartPredicate(CMemoryPool *mp, CMDAccessor *md_accessor, IDatum *datum,
													CRange::ERangeInclusion eri, IMDId *pmdidPartKeyType,
													ULONG ulPartLevel)
{
	const IMDType *pmdtype = md_accessor->RetrieveType(pmdidPartKeyType);

	return PdxlnRangePointPredicate(mp, md_accessor, datum, eri, pmdidPartKeyType,
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnRangeEndPredicate(CMemoryPool *mp, CMDAccessor *md_accessor, IDatum *datum,
												  CRange::ERangeInclusion eri, IMDId *pmdidPartKeyType,
												  ULONG ulPartLevel)
{
	const IMDType *pmdtype = md_accessor->RetrieveType(pmdidPartKeyType);
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnRangePointPredicate(CMemoryPool *mp, CMDAccessor *md_accessor, IDatum *datum,
													CRange::ERangeInclusion eri, IMDId *pmdidPartKeyType,
													IMDId *pmdidCmpExl, IMDId *pmdidCmpIncl, ULONG ulPartLevel,
													BOOL is_lower_bound)
{
	if (NULL == datum)
	{
		// point in an unbounded range: create a predicate (open-ended)
		return GPOS_NEW(mp) CDXLNode(mp, GPOS_NEW(mp) CDXLScalarPartBoundOpen(mp, ulPartLevel, is_lower_bound));
	}

	pmdidPartKeyType->AddRef();
	CDXLNode *pdxlnPartBound =
		GPOS_NEW(mp) CDXLNode(mp, GPOS_NEW(mp) CDXLScalarPartBound(mp, ulPartLevel, pmdidPartKeyType, is_lower_bound));
	...
	CWStringConst *pstrCmpExcl =
		GPOS_NEW(mp) CWStringConst(mp, md_accessor->RetrieveScOp(pmdidCmpExl)->Mdname().GetMDName()->GetBuffer());
	CDXLNode *pdxlnPredicateExclusive = GPOS_NEW(mp)
		CDXLNode(mp, GPOS_NEW(mp) CDXLScalarComp(mp, pmdidCmpExl, pstrCmpExcl), pdxlnPoint, pdxlnPartBound);

	// generate a predicate of the form "point <= col and colIncluded" / "point >= col and colIncluded"
	pmdidCmpIncl->AddRef();

	CWStringConst *pstrCmpIncl =
		GPOS_NEW(mp) CWStringConst(mp, md_accessor->RetrieveScOp(pmdidCmpIncl)->Mdname().GetMDName()->GetBuffer());
	pdxlnPartBound->AddRef();
	pdxlnPoint->AddRef();
	CDXLNode *pdxlnCmpIncl = GPOS_NEW(mp)
		CDXLNode(mp, GPOS_NEW(mp) CDXLScalarComp(mp, pmdidCmpIncl, pstrCmpIncl), pdxlnPoint, pdxlnPartBound);

	CDXLNode *pdxlnPartBoundInclusion =
		GPOS_NEW(mp) CDXLNode(mp, GPOS_NEW(mp) CDXLScalarPartBoundInclusion(mp, ulPartLevel, is_lower_bound));

	if (CRange::EriExcluded == eri)
	{
		// negate the "inclusion" portion of the predicate
		pdxlnPartBoundInclusion =
			GPOS_NEW(mp) CDXLNode(mp, GPOS_NEW(mp) CDXLScalarBoolExpr(mp, Edxlnot), pdxlnPartBoundInclusion);
	}

	CDXLNode *pdxlnPredicateInclusive =
		GPOS_NEW(mp) CDXLNode(mp, GPOS_NEW(mp) CDXLScalarBoolExpr(mp, Edxland), pdxlnCmpIncl, pdxlnPartBoundInclusion);

	// return the final predicate in the form "(point <= col and colInclusive) or point < col" / "(point >= col and colInclusive) or point > col"
	return GPOS_NEW(mp)
		CDXLNode(mp, GPOS_NEW(mp) CDXLScalarBoolExpr(mp, Edxlor), pdxlnPredicateInclusive, pdxlnPredicateExclusive);
}


// construct a DXL node for the part key portion of the list partition filter
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnListFilterPartKey(CMemoryPool *mp, CMDAccessor *md_accessor, CExpression *pexprPartKey,
												  IMDId *pmdidTypePartKey, ULONG ulPartLevel)
{
	...
	if (CUtils::FScalarIdent(pexprPartKey))
	{
		...
		pdxlnPartKey = GPOS_NEW(mp)
			CDXLNode(mp, GPOS_NEW(mp) CDXLScalarPartListValues(mp, ulPartLevel, pmdidResultArray, pmdidTypePartKey));
	}
	else if (CScalarIdent::FCastedScId(pexprPartKey) || CScalarIdent::FAllowedFuncScId(pexprPartKey))
	{
		...
		CDXLNode *pdxlnPartKeyIdent = GPOS_NEW(mp)
			CDXLNode(mp, GPOS_NEW(mp) CDXLScalarPartListValues(mp, ulPartLevel, pmdidSrcArray, pmdidSrcElem));

		pmdidDestArray->AddRef();
		pmdidArrayCastFunc->AddRef();
		pdxlnPartKey =
			GPOS_NEW(mp) CDXLNode(mp,
								  GPOS_NEW(mp) CDXLScalarArrayCoerceExpr(mp, pmdidArrayCastFunc, pmdidDestArray,
	...
	else
	{
		...
		GPOS_THROW_EXCEPTION(gpopt::ExmaGPOPT, gpopt::ExmiUnsupportedOp, CException::ExsevDebug1, str->GetBuffer());
	}
...
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnListFilterScCmp(CMemoryPool *mp, CMDAccessor *md_accessor, CDXLNode *pdxlnPartKey,
	...
	CDXLNode *pdxlnScCmp = GPOS_NEW(mp)
		CDXLNode(mp,
				 GPOS_NEW(mp) CDXLScalarArrayComp(
					 mp, pmdidScCmp, GPOS_NEW(mp) CWStringConst(mp, pstrScCmp->GetBuffer()), Edxlarraycomptypeany),
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnRangeFilterScCmp(CMemoryPool *mp, CMDAccessor *md_accessor, CDXLNode *pdxlnScalar,
												 ...
												 IMDType::ECmpType cmp_type, ULONG ulPartLevel)
{
	...
	{
		return PdxlnRangeFilterEqCmp(mp, md_accessor, pdxlnScalar, pmdidTypePartKey, pmdidTypeOther, pmdidTypeCastExpr,
									 mdid_cast_func, ulPartLevel);
	}
	...
	if (IMDType::EcmptLEq != cmp_type && IMDType::EcmptGEq != cmp_type)
	{
		...
		CDXLNode *pdxlnPredicateExclusive =
			PdxlnCmp(mp, md_accessor, ulPartLevel, fLowerBound, pdxlnScalar, ecmptScCmp, pmdidTypePartKey,
	...
	CDXLNode *pdxlnInclusiveCmp = PdxlnCmp(mp, md_accessor, ulPartLevel, fLowerBound, pdxlnScalar, cmp_type,
	...
	pdxlnScalar->AddRef();
	CDXLNode *pdxlnPredicateExclusive = PdxlnCmp(mp, md_accessor, ulPartLevel, fLowerBound, pdxlnScalar, ecmptScCmp,
												 pmdidTypePartKey, pmdidTypeOther, pmdidTypeCastExpr, mdid_cast_func);

	CDXLNode *pdxlnInclusiveBoolPredicate =
		GPOS_NEW(mp) CDXLNode(mp, GPOS_NEW(mp) CDXLScalarPartBoundInclusion(mp, ulPartLevel, fLowerBound));

	CDXLNode *pdxlnPredicateInclusive = GPOS_NEW(mp)
		CDXLNode(mp, GPOS_NEW(mp) CDXLScalarBoolExpr(mp, Edxland), pdxlnInclusiveCmp, pdxlnInclusiveBoolPredicate);
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnRangeFilterEqCmp(CMemoryPool *mp, CMDAccessor *md_accessor, CDXLNode *pdxlnScalar,
												 IMDId *pmdidTypePartKey, IMDId *pmdidTypeOther,
												 IMDId *pmdidTypeCastExpr, IMDId *mdid_cast_func, ULONG ulPartLevel)
{
	CDXLNode *pdxlnPredicateMin =
		PdxlnRangeFilterPartBound(mp, md_accessor, pdxlnScalar, pmdidTypePartKey, pmdidTypeOther, pmdidTypeCastExpr,
								  mdid_cast_func, ulPartLevel, true /*fLowerBound*/, IMDType::EcmptL);
	pdxlnScalar->AddRef();
	CDXLNode *pdxlnPredicateMax =
		PdxlnRangeFilterPartBound(mp, md_accessor, pdxlnScalar, pmdidTypePartKey, pmdidTypeOther, pmdidTypeCastExpr,
								  mdid_cast_func, ulPartLevel, false /*fLowerBound*/, IMDType::EcmptG);

	// return the conjunction of the predicate for the lower and upper bounds
	return GPOS_NEW(mp)
		CDXLNode(mp, GPOS_NEW(mp) CDXLScalarBoolExpr(mp, Edxland), pdxlnPredicateMin, pdxlnPredicateMax);
}
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnRangeFilterPartBound(CMemoryPool *mp, CMDAccessor *md_accessor, CDXLNode *pdxlnScalar,
													 IMDId *pmdidTypePartKey, IMDId *pmdidTypeOther,
													 IMDId *pmdidTypeCastExpr, IMDId *mdid_cast_func, ULONG ulPartLevel,
													 ULONG fLowerBound, IMDType::ECmpType cmp_type)
{
	...
	CDXLNode *pdxlnInclusiveCmp = PdxlnCmp(mp, md_accessor, ulPartLevel, fLowerBound, pdxlnScalar, ecmptInc,
										   pmdidTypePartKey, pmdidTypeOther, pmdidTypeCastExpr, mdid_cast_func);
	...
	CDXLNode *pdxlnPredicateExclusive = PdxlnCmp(mp, md_accessor, ulPartLevel, fLowerBound, pdxlnScalar, cmp_type,
												 pmdidTypePartKey, pmdidTypeOther, pmdidTypeCastExpr, mdid_cast_func);
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnRangeFilterDefaultAndOpenEnded(CMemoryPool *mp, ULONG ulPartLevel, BOOL fLTComparison,
															   BOOL fGTComparison, BOOL fEQComparison,
															   BOOL fDefaultPart)
{
	...
	if (fLTComparison || fEQComparison)
	{
		...
		pdxlnResult =
			GPOS_NEW(mp) CDXLNode(mp, GPOS_NEW(mp) CDXLScalarPartBoundOpen(mp, ulPartLevel, true /*is_lower_bound*/));
	}

	if (fGTComparison || fEQComparison)
	{
		// add a condition to cover the cases of open-ended interval (x, inf)
		CDXLNode *pdxlnOpenMax =
			GPOS_NEW(mp) CDXLNode(mp, GPOS_NEW(mp) CDXLScalarPartBoundOpen(mp, ulPartLevel, false /*is_lower_bound*/));

		// construct a boolean OR expression over the two expressions
		if (NULL != pdxlnResult)
		{
			pdxlnResult =
				GPOS_NEW(mp) CDXLNode(mp, GPOS_NEW(mp) CDXLScalarBoolExpr(mp, Edxlor), pdxlnResult, pdxlnOpenMax);
		}
		else
		{
	...
	if (fDefaultPart)
	{
		...
		{
			pdxlnResult =
				GPOS_NEW(mp) CDXLNode(mp, GPOS_NEW(mp) CDXLScalarBoolExpr(mp, Edxlor), pdxlnDefault, pdxlnResult);
		}
		else
		{
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnCmp(CMemoryPool *mp, CMDAccessor *md_accessor, ULONG ulPartLevel, BOOL fLowerBound,
									CDXLNode *pdxlnScalar, IMDType::ECmpType cmp_type, IMDId *pmdidTypePartKey,
									IMDId *pmdidTypeExpr, IMDId *pmdidTypeCastExpr, IMDId *mdid_cast_func)
{
	IMDId *pmdidScCmp = NULL;
	...
	{
		pmdidScCmp =
			CMDAccessorUtils::GetScCmpMdIdConsiderCasts(md_accessor, pmdidTypeCastExpr, pmdidTypeExpr, cmp_type);
	}
	else
	{
		pmdidScCmp =
			CMDAccessorUtils::GetScCmpMdIdConsiderCasts(md_accessor, pmdidTypePartKey, pmdidTypeExpr, cmp_type);
	}
	...
	CDXLScalarComp *pdxlopCmp =
		GPOS_NEW(mp) CDXLScalarComp(mp, pmdidScCmp, GPOS_NEW(mp) CWStringConst(mp, pstrScCmp->GetBuffer()));
	CDXLNode *pdxlnScCmp = GPOS_NEW(mp) CDXLNode(mp, pdxlopCmp);

	pmdidTypePartKey->AddRef();
	CDXLNode *pdxlnPartBound =
		GPOS_NEW(mp) CDXLNode(mp, GPOS_NEW(mp) CDXLScalarPartBound(mp, ulPartLevel, pmdidTypePartKey, fLowerBound));
	...
	if (IMDId::IsValid(pmdidTypeCastExpr))
	{
		...
		pdxlnPartBound = GPOS_NEW(mp)
			CDXLNode(mp, GPOS_NEW(mp) CDXLScalarCast(mp, pmdidTypeCastExpr, mdid_cast_func), pdxlnPartBound);
	}
...
//---------------------------------------------------------------------------
CColRef *
CTranslatorExprToDXLUtils::PcrCreate(CMemoryPool *mp, CMDAccessor *md_accessor, CColumnFactory *col_factory,
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnProjListFromChildProjList(CMemoryPool *mp, CColumnFactory *col_factory,
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnPrLPartitionSelector(CMemoryPool *mp, CMDAccessor *md_accessor,
													 CColumnFactory *col_factory, ColRefToDXLNodeMap *phmcrdxln,
													 BOOL fUseChildProjList, CDXLNode *pdxlnPrLChild, CColRef *pcrOid,
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnPropExprPartitionSelector(CMemoryPool *mp, CMDAccessor *md_accessor,
														  CColumnFactory *col_factory, BOOL fConditional,
														  UlongToPartConstraintMap *ppartcnstrmap,
														  ...
														  CharPtrArray *pdrgszPartTypes)
{
	...
	return PdxlnPropagationExpressionForPartConstraints(mp, md_accessor, col_factory, ppartcnstrmap, pdrgpdrgpcrKeys,
														pdrgszPartTypes);
}
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnProjElem(CMemoryPool *mp, CColumnFactory *col_factory, ColRefToDXLNodeMap *phmcrdxln,
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnIdent(CMemoryPool *mp, ColRefToDXLNodeMap *phmcrdxlnSubplans,
...
//---------------------------------------------------------------------------
IDatumArray *
CTranslatorExprToDXLUtils::PdrgpdatumNulls(CMemoryPool *mp, CColRefArray *colref_array)
{
...
//---------------------------------------------------------------------------
CColRefArray *
CTranslatorExprToDXLUtils::PdrgpcrMapColumns(CMemoryPool *mp, CColRefArray *pdrgpcrInput, ColRefToUlongMap *phmcrul,
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnResult(CMemoryPool *mp, CDXLPhysicalProperties *dxl_properties, CDXLNode *pdxlnPrL,
...
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnValuesScan(CMemoryPool *mp, CDXLPhysicalProperties *dxl_properties, CDXLNode *pdxlnPrL,
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnPartitionSelector(CMemoryPool *mp, IMDId *mdid, ULONG ulPartLevels, ULONG scan_id,
												  ...
												  CDXLNode *pdxlnPrintable, CDXLNode *child_dxlnode)
{
	CDXLNode *pdxlnSelector =
		GPOS_NEW(mp) CDXLNode(mp, GPOS_NEW(mp) CDXLPhysicalPartitionSelector(mp, mdid, ulPartLevels, scan_id));
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorExprToDXLUtils::PdxlnCombineBoolean(CMemoryPool *mp, CDXLNode *first_child_dxlnode,
...
//---------------------------------------------------------------------------
ColRefToUlongMap *
CTranslatorExprToDXLUtils::PhmcrulColIndex(CMemoryPool *mp, CColRefArray *colref_array)
{
...
//---------------------------------------------------------------------------
void
CTranslatorExprToDXLUtils::SetStats(CMemoryPool *mp, CMDAccessor *md_accessor, CDXLNode *dxlnode,
...
//---------------------------------------------------------------------------
void
CTranslatorExprToDXLUtils::SetDirectDispatchInfo(CMemoryPool *mp, CMDAccessor *md_accessor, CDXLNode *dxlnode,
...
CTranslatorExprToDXLUtils::GetDXLDirectDispatchInfo(CMemoryPool *mp, CMDAccessor *md_accessor,
...
//---------------------------------------------------------------------------
CDXLDirectDispatchInfo *
CTranslatorExprToDXLUtils::PdxlddinfoSingleDistrKey(CMemoryPool *mp, CMDAccessor *md_accessor, CExpression *pexprHashed,
													CConstraint *pcnstr)
{
...
//---------------------------------------------------------------------------
BOOL
CTranslatorExprToDXLUtils::FDirectDispatchable(const CColRef *pcrDistrCol, const CDXLDatum *dxl_datum)
{
...
//---------------------------------------------------------------------------
CDXLDatum *
CTranslatorExprToDXLUtils::PdxldatumFromPointConstraint(CMemoryPool *mp, CMDAccessor *md_accessor,
														const CColRef *pcrDistrCol, CConstraint *pcnstrDistrCol)
{
	if (!CPredicateUtils::FConstColumn(pcnstrDistrCol, pcrDistrCol))
	{
		return NULL;
...
//---------------------------------------------------------------------------
CDXLDatum2dArray *
CTranslatorExprToDXLUtils::PdrgpdrgpdxldatumFromDisjPointConstraint(CMemoryPool *mp, CMDAccessor *md_accessor,
...
//---------------------------------------------------------------------------
void
CTranslatorExprToDXLUtils::ExtractCastFuncMdids(COperator *pop, IMDId **ppmdidType, IMDId **ppmdidCastFunc)
{
...
BOOL
CTranslatorExprToDXLUtils::FDXLOpExists(const CDXLOperator *pop, const gpdxl::Edxlopid *peopid, ULONG ulOps)
{
	GPOS_ASSERT(NULL != pop);
...
BOOL
CTranslatorExprToDXLUtils::FHasDXLOp(const CDXLNode *dxlnode, const gpdxl::Edxlopid *peopid, ULONG ulOps)
{
...
BOOL
CTranslatorExprToDXLUtils::FMotionHazard(CMemoryPool *mp, CDXLNode *dxlnode, const gpdxl::Edxlopid *peopid, ULONG ulOps,
										 CBitSet *pbsPrjCols)
{
