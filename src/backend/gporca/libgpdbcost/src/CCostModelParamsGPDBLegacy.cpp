...
const CHAR rgszCostParamNames[CCostModelParamsGPDBLegacy::EcpSentinel][GPOPT_COSTPARAM_NAME_MAX_LENGTH] = {
	"SeqIOBandwidth", "RandomIOBandwidth", "TupProcBandwidth", "TupUpdateBandwidth", "NetworkBandwidth", "Segments",
	"NLJOuterFactor", "NLJFactor",		   "HJFactor",		   "HashFactor",		 "DefaultCost",
};
...
CCostModelParamsGPDBLegacy::CCostModelParamsGPDBLegacy(CMemoryPool *mp) : m_mp(mp)
{
	...
	m_rgpcp[EcpNLJOuterFactor] = GPOS_NEW(mp)
		SCostParam(EcpNLJOuterFactor, DNLJOuterFactorVal, DNLJOuterFactorVal - 128.0, DNLJOuterFactorVal + 128.0);
...
//---------------------------------------------------------------------------
void
CCostModelParamsGPDBLegacy::SetParam(ULONG id, CDouble dVal, CDouble dLowerBound, CDouble dUpperBound)
{
	ECostParam ecp = (ECostParam) id;
	GPOS_ASSERT(EcpSentinel > ecp);
...
//---------------------------------------------------------------------------
void
CCostModelParamsGPDBLegacy::SetParam(const CHAR *szName, CDouble dVal, CDouble dLowerBound, CDouble dUpperBound)
{
	GPOS_ASSERT(NULL != szName);
